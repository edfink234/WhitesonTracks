...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset_only:
        ...
        eps = .02
        w = 0.28
        plot_func =    -s*(-s*(3.88365470449514e-7*s*(sp.sech(sp.cos(sp.sqrt(s)))) - 7.81871564723424e-5) - 0.00260537062787547)*sp.sin(s)*sp.asin(sp.cos(s*(sp.sech(sp.tanh(s))) - 0.756802495307928)) + 12.9746219558192*s*(sp.sqrt((sp.sech(s))) - 0.0412352518417774) - 0.0529165490322892*s*sp.sin(0.262783179800533*s) - 1.39354257484557*s*sp.sin(s + 0.484821716341265)*(sp.sech(3.57142857142857*s - 425)) - 0.00804096255023509*s*sp.sin(0.429203673205103*s**2 - 0.975483940016667) - 0.354807349081669*s*sp.tanh(sp.sin(1.08959504574587*sp.sqrt(s))) + 0.000640289717875553*s + 8.08339490057823*(3.42927754351745 - 8.17051658774659e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) - (-0.00182046900716881*s - (-0.531677337704049*sp.sin(s)*sp.cos(sp.sqrt(s)) - 0.531677337704049*sp.cos(s) - 0.0503647990181936)*sp.sin(s))*sp.cos(0.856996688691341*s - 0.322806427311516) + (0.00111888702259311*s - sp.asin(0.0524369375026477*sp.sin(s**2) - 0.0524369375026477*sp.cos(s)*sp.tanh(s) - 0.0524369375026477*sp.cos(s**2) + 0.0524369375026477*sp.asin(sp.tanh(s))))*sp.sin(s) - 0.643021878478269*(s - 3.84104811871141)*(-s*sp.cos(s) - sp.sin(s) - 0.607440854938994)*(sp.sech(0.371435670950793*s)) + (-(0.000774642772674805*s - 0.188274778371372)*(-0.0101188246288049*s - sp.sin(sp.sqrt(s)) - 0.450357723307261*sp.sin(s) - sp.cos(s) + sp.tanh(s) + 0.354907148478142)*sp.cos(4*s + sp.sin(2*s)) - 0.075550772349475)*sp.acos(-sp.cos(s)) + (0.403790219061802*sp.sqrt(1 - sp.cos(s)**2) - 0.403790219061802*sp.tanh(s))*sp.sin(-0.26580222883408*sp.sqrt(s) + s*sp.asin(sp.tanh(s)) + sp.asin(sp.cos(0.0751360908983532*s*(s + 0.0751360908983532)))) - (-0.82534386912471*sp.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) - 0.331711026550589)*sp.cos(s) - (0.581679426571627*sp.cos(s) + 0.397602283363534)*sp.sin(s*(0.873362574933699 - 0.888385561585661*s)) + ((sp.sech(sp.sin((s - 0.0718006283709958)*sp.tanh(sp.tanh(s))))) - (sp.sech(sp.asin(sp.cos(0.906818140870912*s + 0.459861281860669)))))*(-2.42499013849638*sp.sin(s) + 2.42499013849638*sp.tanh(s) - 0.729550248336663) + 0.868204852937739*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.62442428920744*sp.sin(0.367879441171442*s) + 1.4905662994602*sp.sin(0.713731637960093*s) - 0.250926902889017*sp.sin(s)**2*sp.sin(1.07250742738533*sp.sqrt(-s*(-sp.sqrt(s) - 0.497473708504806))) + 1.4905662994602*sp.sin(0.637439071877847*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.868204852937739*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.868204852937739*sp.sin(1.01897094686277*s*sp.sin(0.999857337167407*s)) + 0.868204852937739*sp.sin(s*sp.cos((sp.sech(0.0136985281801015*s)))) + 0.107115671699926*sp.sin(s**2*sp.cos(sp.cos(s))) - 0.237140870305564*sp.sin(sp.sqrt(abs(s**2*(2*s - 0.939063731834503)))*sp.sin(s)) + 2.42853957558846*sp.sin(0.451582705289455*s - 0.365159782650125) - 0.868204852937739*sp.sin(0.631449858567625*s + 0.419425530962709) + 0.0939805312796745*sp.sin(s*(sp.sin(s) + (sp.sech(s))) - s) + 0.868204852937739*sp.sin(sp.cos(s**(5/4))) - 0.188255609691216*sp.cos(sp.sqrt(s))*sp.cos(3*s + sp.sin(sp.sqrt(s)) + 0.179639474703103) - 8.08339490057823*sp.cos(0.184501965675006*s) + 1.4905662994602*sp.cos(0.859238155913655*s) - sp.cos(s)*sp.acos(sp.sin(sp.cos(sp.sin(1.97493799097939*s)))) + 0.299030627307264*sp.cos(1.44312628154549*s) + 0.868204852937739*sp.cos(1.52297301362374*s**2) + 0.868204852937739*sp.cos(sp.sqrt(s)*sp.sin(s + 0.700783089090742)) + 0.868204852937739*sp.cos(s*(1.5981910667683 - s)) + 0.868204852937739*sp.cos(s*(2*s + 0.258012275465596)) - 0.310034292330473*sp.cos(s*(1.00300385903529*sp.sin(s) + 1.91878516265159)) + 0.868204852937739*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 0.408251037310486*sp.cos(1.10583897256825*s*(-(sp.sech(s)) - sp.sqrt((sp.sech(sp.sin(s)))) + 0.705026843555238)) + 1.4905662994602*sp.cos(0.956994426515978*s + 0.69851369566006) + sp.cos(sp.sin(1.41588210657922*s*sp.sqrt(s + 0.604307210566622))) - 0.868204852937739*sp.tanh(sp.sin(1.01601732983085*sp.sqrt(s) + 1.01601732983085*s)) + sp.tanh(sp.cos(s)) + 0.868204852937739*sp.tanh(sp.cos(5.00420342832107*s)) + 0.868204852937739*sp.tanh(sp.cos(s*(1.00012530357858*s + 0.0366189934736865))) - 0.505455308880222*sp.acos(sp.sin(0.765267107370348*s)) + 2.42853957558846*sp.acos(sp.sin(0.517512499805315*s + 0.497299438208891)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.924548053769657))) + sp.asin(0.122695961260996*sp.sin(sp.sqrt(s) + s*(s**(1/4) - sp.sqrt(s)) - 0.543338234619709)) + 1.4905662994602*sp.asin(sp.cos(0.25*s)) + 1.4905662994602*sp.asin(sp.cos(0.26580222883408*s)) + 1.4905662994602*sp.asin(sp.cos(0.594932778023209*s)) + 0.27552651140119*sp.asin(sp.cos(s*(s + 0.26580222883408))) - 0.25983931135938*sp.asin(sp.cos((s + 0.356921100186546)*(0.654182574305564*sp.cos(s) + 2))) + 0.868204852937739*sp.asin(sp.cos(0.983047194673816*sp.sqrt(s) + 0.983047194673816*s)) + sp.asin((sp.sech(3.88190966566046*sp.sin(s)))) - 3.01434387531601 if fitPlotFunc else lambda s: -s*(-s*(3.88365470449514e-7*s*(np.sech(np.cos(np.sqrt(s)))) - 7.81871564723424e-5) - 0.00260537062787547)*np.sin(s)*np.asin(np.cos(s*(np.sech(np.tanh(s))) - 0.756802495307928)) + 12.9746219558192*s*(np.sqrt((np.sech(s))) - 0.0412352518417774) - 0.0529165490322892*s*np.sin(0.262783179800533*s) - 1.39354257484557*s*np.sin(s + 0.484821716341265)*(np.sech(3.57142857142857*s - 425)) - 0.00804096255023509*s*np.sin(0.429203673205103*s**2 - 0.975483940016667) - 0.354807349081669*s*np.tanh(np.sin(1.08959504574587*np.sqrt(s))) + 0.000640289717875553*s + 8.08339490057823*(3.42927754351745 - 8.17051658774659e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) - (-0.00182046900716881*s - (-0.531677337704049*np.sin(s)*np.cos(np.sqrt(s)) - 0.531677337704049*np.cos(s) - 0.0503647990181936)*np.sin(s))*np.cos(0.856996688691341*s - 0.322806427311516) + (0.00111888702259311*s - np.asin(0.0524369375026477*np.sin(s**2) - 0.0524369375026477*np.cos(s)*np.tanh(s) - 0.0524369375026477*np.cos(s**2) + 0.0524369375026477*np.asin(np.tanh(s))))*np.sin(s) - 0.643021878478269*(s - 3.84104811871141)*(-s*np.cos(s) - np.sin(s) - 0.607440854938994)*(np.sech(0.371435670950793*s)) + (-(0.000774642772674805*s - 0.188274778371372)*(-0.0101188246288049*s - np.sin(np.sqrt(s)) - 0.450357723307261*np.sin(s) - np.cos(s) + np.tanh(s) + 0.354907148478142)*np.cos(4*s + np.sin(2*s)) - 0.075550772349475)*np.acos(-np.cos(s)) + (0.403790219061802*np.sqrt(1 - np.cos(s)**2) - 0.403790219061802*np.tanh(s))*np.sin(-0.26580222883408*np.sqrt(s) + s*np.asin(np.tanh(s)) + np.asin(np.cos(0.0751360908983532*s*(s + 0.0751360908983532)))) - (-0.82534386912471*np.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) - 0.331711026550589)*np.cos(s) - (0.581679426571627*np.cos(s) + 0.397602283363534)*np.sin(s*(0.873362574933699 - 0.888385561585661*s)) + ((np.sech(np.sin((s - 0.0718006283709958)*np.tanh(np.tanh(s))))) - (np.sech(np.asin(np.cos(0.906818140870912*s + 0.459861281860669)))))*(-2.42499013849638*np.sin(s) + 2.42499013849638*np.tanh(s) - 0.729550248336663) + 0.868204852937739*np.sin(np.sqrt(s))*np.cos(2*s) - 5.62442428920744*np.sin(0.367879441171442*s) + 1.4905662994602*np.sin(0.713731637960093*s) - 0.250926902889017*np.sin(s)**2*np.sin(1.07250742738533*np.sqrt(-s*(-np.sqrt(s) - 0.497473708504806))) + 1.4905662994602*np.sin(0.637439071877847*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.868204852937739*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.868204852937739*np.sin(1.01897094686277*s*np.sin(0.999857337167407*s)) + 0.868204852937739*np.sin(s*np.cos((np.sech(0.0136985281801015*s)))) + 0.107115671699926*np.sin(s**2*np.cos(np.cos(s))) - 0.237140870305564*np.sin(np.sqrt(abs(s**2*(2*s - 0.939063731834503)))*np.sin(s)) + 2.42853957558846*np.sin(0.451582705289455*s - 0.365159782650125) - 0.868204852937739*np.sin(0.631449858567625*s + 0.419425530962709) + 0.0939805312796745*np.sin(s*(np.sin(s) + (np.sech(s))) - s) + 0.868204852937739*np.sin(np.cos(s**(5/4))) - 0.188255609691216*np.cos(np.sqrt(s))*np.cos(3*s + np.sin(np.sqrt(s)) + 0.179639474703103) - 8.08339490057823*np.cos(0.184501965675006*s) + 1.4905662994602*np.cos(0.859238155913655*s) - np.cos(s)*np.acos(np.sin(np.cos(np.sin(1.97493799097939*s)))) + 0.299030627307264*np.cos(1.44312628154549*s) + 0.868204852937739*np.cos(1.52297301362374*s**2) + 0.868204852937739*np.cos(np.sqrt(s)*np.sin(s + 0.700783089090742)) + 0.868204852937739*np.cos(s*(1.5981910667683 - s)) + 0.868204852937739*np.cos(s*(2*s + 0.258012275465596)) - 0.310034292330473*np.cos(s*(1.00300385903529*np.sin(s) + 1.91878516265159)) + 0.868204852937739*np.cos(s*(np.asin(np.cos(s)) + 2)) + 0.408251037310486*np.cos(1.10583897256825*s*(-(np.sech(s)) - np.sqrt((np.sech(np.sin(s)))) + 0.705026843555238)) + 1.4905662994602*np.cos(0.956994426515978*s + 0.69851369566006) + np.cos(np.sin(1.41588210657922*s*np.sqrt(s + 0.604307210566622))) - 0.868204852937739*np.tanh(np.sin(1.01601732983085*np.sqrt(s) + 1.01601732983085*s)) + np.tanh(np.cos(s)) + 0.868204852937739*np.tanh(np.cos(5.00420342832107*s)) + 0.868204852937739*np.tanh(np.cos(s*(1.00012530357858*s + 0.0366189934736865))) - 0.505455308880222*np.acos(np.sin(0.765267107370348*s)) + 2.42853957558846*np.acos(np.sin(0.517512499805315*s + 0.497299438208891)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.924548053769657))) + np.asin(0.122695961260996*np.sin(np.sqrt(s) + s*(s**(1/4) - np.sqrt(s)) - 0.543338234619709)) + 1.4905662994602*np.asin(np.cos(0.25*s)) + 1.4905662994602*np.asin(np.cos(0.26580222883408*s)) + 1.4905662994602*np.asin(np.cos(0.594932778023209*s)) + 0.27552651140119*np.asin(np.cos(s*(s + 0.26580222883408))) - 0.25983931135938*np.asin(np.cos((s + 0.356921100186546)*(0.654182574305564*np.cos(s) + 2))) + 0.868204852937739*np.asin(np.cos(0.983047194673816*np.sqrt(s) + 0.983047194673816*s)) + np.asin((np.sech(3.88190966566046*np.sin(s)))) - 3.01434387531601

        plot_func_eqn = r"$z(s) = 12.97\cdot s\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) - 0.05\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 1.39\cdot s\cdot \sin{\left(s + 0.48 \right)}\cdot \operatorname{sech}{\left(3.57\cdot s - 425 \right)} - 0.01\cdot s\cdot \sin{\left(0.43\cdot s^{2} - 0.98 \right)} - 0.35\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} - 0.64\cdot \left(s - 3.84\right)\cdot \left(- s\cdot \cos{\left(s \right)} - \sin{\left(s \right)} - 0.61\right)\cdot \operatorname{sech}{\left(0.37\cdot s \right)} + \left(0.19\cdot \left(- 0.01\cdot s - \sin{\left(\sqrt{s} \right)} - 0.45\cdot \sin{\left(s \right)} - \cos{\left(s \right)} + \tanh{\left(s \right)} + 0.35\right)\cdot \cos{\left(4\cdot s + \sin{\left(2\cdot s \right)} \right)} - 0.08\right)\cdot \operatorname{acos}{\left(- \cos{\left(s \right)} \right)} + \left(0.4\cdot \sqrt{1 - \cos^{2}{\left(s \right)}} - 0.4\cdot \tanh{\left(s \right)}\right)\cdot \sin{\left(- 0.27\cdot \sqrt{s} + s\cdot \operatorname{asin}{\left(\tanh{\left(s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(0.08\cdot s\cdot \left(s + 0.08\right) \right)} \right)} \right)} - \left(- 0.83\cdot \sin{\left(\left(2.59 - s\right)\cdot \left(- s - 0.62\right) \right)} - 0.33\right)\cdot \cos{\left(s \right)} - \left(0.58\cdot \cos{\left(s \right)} + 0.4\right)\cdot \sin{\left(s\cdot \left(0.87 - 0.89\cdot s\right) \right)} + \left(\operatorname{sech}{\left(\sin{\left(\left(s - 0.07\right)\cdot \tanh{\left(\tanh{\left(s \right)} \right)} \right)} \right)} - \operatorname{sech}{\left(\operatorname{asin}{\left(\cos{\left(0.91\cdot s + 0.46 \right)} \right)} \right)}\right)\cdot \left(- 2.42\cdot \sin{\left(s \right)} + 2.42\cdot \tanh{\left(s \right)} - 0.73\right) + \left(- 0.53\cdot \sin{\left(s \right)}\cdot \cos{\left(\sqrt{s} \right)} - 0.53\cdot \cos{\left(s \right)} - 0.05\right)\cdot \sin{\left(s \right)}\cdot \cos{\left(0.86\cdot s - 0.32 \right)} + 0.87\cdot \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.62\cdot \sin{\left(0.37\cdot s \right)} + 1.49\cdot \sin{\left(0.71\cdot s \right)} - 0.25\cdot \sin^{2}{\left(s \right)}\cdot \sin{\left(1.07\cdot \sqrt{- s\cdot \left(- \sqrt{s} - 0.5\right)} \right)} - \sin{\left(s \right)}\cdot \operatorname{asin}{\left(0.05\cdot \sin{\left(s^{2} \right)} - 0.05\cdot \cos{\left(s \right)}\cdot \tanh{\left(s \right)} - 0.05\cdot \cos{\left(s^{2} \right)} + 0.05\cdot \operatorname{asin}{\left(\tanh{\left(s \right)} \right)} \right)} + 1.49\cdot \sin{\left(0.64\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + 0.87\cdot \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + 0.87\cdot \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + 0.87\cdot \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + 0.11\cdot \sin{\left(s^{2}\cdot \cos{\left(\cos{\left(s \right)} \right)} \right)} - 0.24\cdot \sin{\left(\sqrt{s^{2}\cdot \left(2\cdot s - 0.94\right)}\cdot \sin{\left(s \right)} \right)} + 27.7144\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.43\cdot \sin{\left(0.45\cdot s - 0.37 \right)} - 0.87\cdot \sin{\left(0.63\cdot s + 0.42 \right)} + 0.09\cdot \sin{\left(s\cdot \left(\sin{\left(s \right)} + \operatorname{sech}{\left(s \right)}\right) - s \right)} + 0.87\cdot \sin{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} - 0.19\cdot \cos{\left(\sqrt{s} \right)}\cdot \cos{\left(3\cdot s + \sin{\left(\sqrt{s} \right)} + 0.18 \right)} - 8.08\cdot \cos{\left(0.18\cdot s \right)} + 1.49\cdot \cos{\left(0.86\cdot s \right)} - \cos{\left(s \right)}\cdot \operatorname{acos}{\left(\sin{\left(\cos{\left(\sin{\left(1.97\cdot s \right)} \right)} \right)} \right)} + 0.3\cdot \cos{\left(1.44\cdot s \right)} + 0.87\cdot \cos{\left(1.52\cdot s^{2} \right)} + 0.87\cdot \cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.7 \right)} \right)} + 0.87\cdot \cos{\left(s\cdot \left(1.6 - s\right) \right)} + 0.87\cdot \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} - 0.31\cdot \cos{\left(s\cdot \left(1.0\cdot \sin{\left(s \right)} + 1.92\right) \right)} + 0.87\cdot \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 0.41\cdot \cos{\left(1.11\cdot s\cdot \left(- \operatorname{sech}{\left(s \right)} - \sqrt{\operatorname{sech}{\left(\sin{\left(s \right)} \right)}} + 0.71\right) \right)} + 1.49\cdot \cos{\left(0.96\cdot s + 0.7 \right)} + \cos{\left(\sin{\left(1.42\cdot s\cdot \sqrt{s + 0.6} \right)} \right)} - 0.87\cdot \tanh{\left(\sin{\left(1.02\cdot \sqrt{s} + 1.02\cdot s \right)} \right)} + \tanh{\left(\cos{\left(s \right)} \right)} + 0.87\cdot \tanh{\left(\cos{\left(5.0\cdot s \right)} \right)} + 0.87\cdot \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} - 0.51\cdot \operatorname{acos}{\left(\sin{\left(0.77\cdot s \right)} \right)} + 2.43\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.5 \right)} \right)} + \operatorname{asin}{\left(0.04\cdot \sqrt{s}\cdot \operatorname{asin}{\left(\cos{\left(0.41\cdot s - 0.41\cdot \cos{\left(s \right)} + 0.92 \right)} \right)} \right)} + \operatorname{asin}{\left(0.12\cdot \sin{\left(\sqrt{s} + s\cdot \left(\sqrt[4]{s} - \sqrt{s}\right) - 0.54 \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.27\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + 0.28\cdot \operatorname{asin}{\left(\cos{\left(s\cdot \left(s + 0.27\right) \right)} \right)} - 0.26\cdot \operatorname{asin}{\left(\cos{\left(\left(s + 0.36\right)\cdot \left(0.65\cdot \cos{\left(s \right)} + 2\right) \right)} \right)} + 0.87\cdot \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} + \operatorname{asin}{\left(\operatorname{sech}{\left(3.88\cdot \sin{\left(s \right)} \right)} \right)} - 3.01$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
