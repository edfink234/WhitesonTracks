...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func =    -0.0545939239702501*s*sp.sin(0.262783179800533*s) - 1.4844612623085*s*sp.sin(s + 0.483970397127895)*(1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))) - 0.355345961566821*s*sp.tanh(sp.sin(1.08978594419407*sp.sqrt(s))) + (2.31541955405362 - 0.00915243761887905*s)*(sp.cos(sp.sin((-s - 0.0440198433647684)*sp.tanh(sp.tanh(s)))) - (1/((1/2)*sp.exp(sp.asin((1/2)*sp.exp(1j*(-0.905956750954937*s - 0.501570467191284)) + (1/2)*sp.exp(1j*(0.905956750954937*s + 0.501570467191284)))) + (1/2)*sp.exp(-sp.asin((1/2)*sp.exp(1j*(-0.905956750954937*s - 0.501570467191284)) + (1/2)*sp.exp(1j*(0.905956750954937*s + 0.501570467191284)))))))*(-sp.sin(s) + sp.tanh(0.049320268324756*s) - 0.192907978776135) + 8.10697114304421*(3.43518895704318 - 8.1723006650769e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 0.496638921573791*(s - 3.87296232937303)*(s*sp.cos(s) + sp.sin(s) + 1.03518545721325)*(1/((1/2)*sp.exp(0.371435670950793*s) + (1/2)*sp.exp(-0.371435670950793*s))) + 6.54973094910627*(2*s + 0.0686716690381427)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0405089461105445) + (0.695706212436234*sp.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.169485354198746)*sp.cos(s) + (-0.774138367862953*sp.cos(s) - 0.385199862543189)*sp.sin(s*(0.874552244364722 - 0.888385561585661*s)) + 0.864123417888688*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.52630635753413*sp.sin(0.367879441171442*s) + 1.49237983046095*sp.sin(0.713731637960093*s) + 1.49237983046095*sp.sin(0.643757935249406*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.864123417888688*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.864123417888688*sp.sin(1.01961760758449*s*sp.sin(0.999857337167407*s)) + 0.864123417888688*sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + 2.43017560525206*sp.sin(0.451582705289455*s - 0.348328403845882) - 0.864123417888688*sp.sin(0.631449858567625*s + 0.294008371816594) + 0.545819477019303*sp.sin(sp.sin(0.765267107370348*s)) + 0.864123417888688*sp.sin(sp.cos(sp.sqrt(s)*sp.sin(s + 0.704613959142765))) - 8.10697114304421*sp.cos(0.184501965675006*s) + 1.49237983046095*sp.cos(0.859238155913655*s) + 0.209400028089802*sp.cos(1.44312628154549*s) + 0.864123417888688*sp.cos(1.52297301362374*s**2) + 0.864123417888688*sp.cos(s*(1.59763417439896 - s)) + 0.864123417888688*sp.cos(s*(2*s + 0.258012275465596)) + 0.864123417888688*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.49237983046095*sp.cos(0.956994426515978*s + 0.706341892454662) - 0.864123417888688*sp.tanh(sp.sin(1.013817625915*sp.sqrt(s) + 1.013817625915*s)) + 0.864123417888688*sp.tanh(sp.cos(5.00420342832107*s)) + 0.864123417888688*sp.tanh(sp.cos(s**(5/4))) + 0.304162809250583*sp.tanh(sp.cos(s*(s + 0.26580222883408))) + 0.864123417888688*sp.tanh(sp.cos(s*(1.00012798041202*s + 0.0366189934736865))) + 2.43017560525206*sp.acos(sp.sin(0.517512499805315*s + 0.562859926438935)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.822982157197199))) + 1.49237983046095*sp.asin(sp.cos(0.25*s)) + 1.49237983046095*sp.asin(sp.cos(0.26580222883408*s)) + 1.49237983046095*sp.asin(sp.cos(0.594932778023209*s)) + 0.864123417888688*sp.asin(sp.cos(0.983157481032705*sp.sqrt(s) + 0.983157481032705*s)) + sp.asin((1/((1/2)*sp.exp(3.45185385673622*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-3.45185385673622*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) - (1/((1/2)*sp.exp(sp.asin((1/2)*sp.exp(1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)) + (1/2)*sp.exp(-1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)))) + (1/2)*sp.exp(-sp.asin((1/2)*sp.exp(1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)) + (1/2)*sp.exp(-1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)))))) - 2.52721743112432 if fitPlotFunc else lambda s: -0.0545939239702501*s*np.sin(0.262783179800533*s) - 1.4844612623085*s*np.sin(s + 0.483970397127895)*(1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))) - 0.355345961566821*s*np.tanh(np.sin(1.08978594419407*np.sqrt(s))) + (2.31541955405362 - 0.00915243761887905*s)*(np.cos(np.sin((-s - 0.0440198433647684)*np.tanh(np.tanh(s)))) - (1/((1/2)*np.exp(np.asin((1/2)*np.exp(1j*(-0.905956750954937*s - 0.501570467191284)) + (1/2)*np.exp(1j*(0.905956750954937*s + 0.501570467191284)))) + (1/2)*np.exp(-np.asin((1/2)*np.exp(1j*(-0.905956750954937*s - 0.501570467191284)) + (1/2)*np.exp(1j*(0.905956750954937*s + 0.501570467191284)))))))*(-np.sin(s) + np.tanh(0.049320268324756*s) - 0.192907978776135) + 8.10697114304421*(3.43518895704318 - 8.1723006650769e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 0.496638921573791*(s - 3.87296232937303)*(s*np.cos(s) + np.sin(s) + 1.03518545721325)*(1/((1/2)*np.exp(0.371435670950793*s) + (1/2)*np.exp(-0.371435670950793*s))) + 6.54973094910627*(2*s + 0.0686716690381427)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0405089461105445) + (0.695706212436234*np.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.169485354198746)*np.cos(s) + (-0.774138367862953*np.cos(s) - 0.385199862543189)*np.sin(s*(0.874552244364722 - 0.888385561585661*s)) + 0.864123417888688*np.sin(np.sqrt(s))*np.cos(2*s) - 5.52630635753413*np.sin(0.367879441171442*s) + 1.49237983046095*np.sin(0.713731637960093*s) + 1.49237983046095*np.sin(0.643757935249406*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.864123417888688*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.864123417888688*np.sin(1.01961760758449*s*np.sin(0.999857337167407*s)) + 0.864123417888688*np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + 2.43017560525206*np.sin(0.451582705289455*s - 0.348328403845882) - 0.864123417888688*np.sin(0.631449858567625*s + 0.294008371816594) + 0.545819477019303*np.sin(np.sin(0.765267107370348*s)) + 0.864123417888688*np.sin(np.cos(np.sqrt(s)*np.sin(s + 0.704613959142765))) - 8.10697114304421*np.cos(0.184501965675006*s) + 1.49237983046095*np.cos(0.859238155913655*s) + 0.209400028089802*np.cos(1.44312628154549*s) + 0.864123417888688*np.cos(1.52297301362374*s**2) + 0.864123417888688*np.cos(s*(1.59763417439896 - s)) + 0.864123417888688*np.cos(s*(2*s + 0.258012275465596)) + 0.864123417888688*np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.49237983046095*np.cos(0.956994426515978*s + 0.706341892454662) - 0.864123417888688*np.tanh(np.sin(1.013817625915*np.sqrt(s) + 1.013817625915*s)) + 0.864123417888688*np.tanh(np.cos(5.00420342832107*s)) + 0.864123417888688*np.tanh(np.cos(s**(5/4))) + 0.304162809250583*np.tanh(np.cos(s*(s + 0.26580222883408))) + 0.864123417888688*np.tanh(np.cos(s*(1.00012798041202*s + 0.0366189934736865))) + 2.43017560525206*np.acos(np.sin(0.517512499805315*s + 0.562859926438935)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.822982157197199))) + 1.49237983046095*np.asin(np.cos(0.25*s)) + 1.49237983046095*np.asin(np.cos(0.26580222883408*s)) + 1.49237983046095*np.asin(np.cos(0.594932778023209*s)) + 0.864123417888688*np.asin(np.cos(0.983157481032705*np.sqrt(s) + 0.983157481032705*s)) + np.asin((1/((1/2)*np.exp(3.45185385673622*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-3.45185385673622*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) - (1/((1/2)*np.exp(np.asin((1/2)*np.exp(1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)) + (1/2)*np.exp(-1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)))) + (1/2)*np.exp(-np.asin((1/2)*np.exp(1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)) + (1/2)*np.exp(-1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)))))) - 2.52721743112432

        plot_func_eqn = r"$z(s) = - 0.05\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 1.48\cdot s\cdot \sin{\left(s + 0.48 \right)}\cdot \operatorname{sech}{\left(3.57\cdot s - 425 \right)} - 0.36\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + \left(2.32 - 0.01\cdot s\right)\cdot \left(\cos{\left(\sin{\left(\left(- s - 0.04\right)\cdot \tanh{\left(\tanh{\left(s \right)} \right)} \right)} \right)} - \operatorname{sech}{\left(\operatorname{asin}{\left(\cos{\left(0.91\cdot s + 0.5 \right)} \right)} \right)}\right)\cdot \left(- \sin{\left(s \right)} + \tanh{\left(0.05\cdot s \right)} - 0.19\right) + 0.5\cdot \left(s - 3.87\right)\cdot \left(s\cdot \cos{\left(s \right)} + \sin{\left(s \right)} + 1.04\right)\cdot \operatorname{sech}{\left(0.37\cdot s \right)} + 6.55\cdot \left(2\cdot s + 0.07\right)\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) + \left(0.7\cdot \sin{\left(\left(2.59 - s\right)\cdot \left(- s - 0.62\right) \right)} + 0.17\right)\cdot \cos{\left(s \right)} + \left(- 0.77\cdot \cos{\left(s \right)} - 0.39\right)\cdot \sin{\left(s\cdot \left(0.87 - 0.89\cdot s\right) \right)} + 0.86\cdot \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.53\cdot \sin{\left(0.37\cdot s \right)} + 1.49\cdot \sin{\left(0.71\cdot s \right)} + 1.49\cdot \sin{\left(0.64\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + 0.86\cdot \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + 27.8984\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.43\cdot \sin{\left(0.45\cdot s - 0.35 \right)} - 0.86\cdot \sin{\left(0.63\cdot s + 0.29 \right)} + 0.55\cdot \sin{\left(\sin{\left(0.77\cdot s \right)} \right)} + 0.86\cdot \sin{\left(\cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.7 \right)} \right)} \right)} - 8.11\cdot \cos{\left(0.18\cdot s \right)} + 1.49\cdot \cos{\left(0.86\cdot s \right)} + 0.21\cdot \cos{\left(1.44\cdot s \right)} + 0.86\cdot \cos{\left(1.52\cdot s^{2} \right)} + 0.86\cdot \cos{\left(s\cdot \left(1.6 - s\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.49\cdot \cos{\left(0.96\cdot s + 0.71 \right)} - 0.86\cdot \tanh{\left(\sin{\left(1.01\cdot \sqrt{s} + 1.01\cdot s \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(5.0\cdot s \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} + 0.3\cdot \tanh{\left(\cos{\left(s\cdot \left(s + 0.27\right) \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} + 2.43\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.56 \right)} \right)} + \operatorname{asin}{\left(0.04\cdot \sqrt{s}\cdot \operatorname{asin}{\left(\cos{\left(0.41\cdot s - 0.41\cdot \cos{\left(s \right)} + 0.82 \right)} \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.27\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + 0.86\cdot \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} + \operatorname{asin}{\left(\operatorname{sech}{\left(6.9\cdot \sin{\left(s \right)} \right)} \right)} - \operatorname{sech}{\left(\operatorname{asin}{\left(\cos{\left(1.42\cdot s\cdot \sqrt{s + 0.6} \right)} \right)} \right)} - 2.53$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
