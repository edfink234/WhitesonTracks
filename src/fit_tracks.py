...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset_only:
        ...
        eps = .02
        w = 0.28
        plot_func =       -1.25290150670153*s**(1/4) + (-0.363106606960233*s + sp.acos(s))*(12.5362011759653*s*(-s*sp.asin(s) + 0.592012631177215)*(s*(s**2 + sp.sin(s)) - s + 0.419979108297422)*sp.sin(3.13320097487757*s)*sp.cos(49.6016134939281*sp.acos(s)) + 4.64094344710726) + 2.05028051349439*(sp.sqrt(1 - sp.sin(5.47491454998871*s)**2) + (sp.asin(0.162023416558629*s) + 0.76488223220492)*(16.2799846234929*sp.sin(5.38484588599688*s) - 5.35566274932423*sp.sin(9.81799848956101*s) - 13.2259393678992*sp.sin(13.4000533974842*s) + sp.cos(32.9690359373047*s)) - 0.156149620035014*sp.sin(26.7019167669519*sp.acos(s)) - 0.344811891145765*sp.cos(92.475900215986*sp.cos(s)))*sp.cos(0.501840824182691*sp.cos(3.11129774897303*s)) - 9.85806810437636*sp.cos(sp.sin(s)) + 2.05028051349439*sp.tanh(sp.acos(s)) - 9.85806810437636*sp.asin(sp.cos(s)) - 2.05028051349439*sp.asin((sp.sech(sp.tanh(sp.cos(14.7529124664426*s))))) - 2.05028051349439*(sp.sech(s*sp.sin(s))) + 13.0755347870728 if fitPlotFunc else lambda s: -1.25290150670153*s**(1/4) + (-0.363106606960233*s + np.acos(s))*(12.5362011759653*s*(-s*np.asin(s) + 0.592012631177215)*(s*(s**2 + np.sin(s)) - s + 0.419979108297422)*np.sin(3.13320097487757*s)*np.cos(49.6016134939281*np.acos(s)) + 4.64094344710726) + 2.05028051349439*(np.sqrt(1 - np.sin(5.47491454998871*s)**2) + (np.asin(0.162023416558629*s) + 0.76488223220492)*(16.2799846234929*np.sin(5.38484588599688*s) - 5.35566274932423*np.sin(9.81799848956101*s) - 13.2259393678992*np.sin(13.4000533974842*s) + np.cos(32.9690359373047*s)) - 0.156149620035014*np.sin(26.7019167669519*np.acos(s)) - 0.344811891145765*np.cos(92.475900215986*np.cos(s)))*np.cos(0.501840824182691*np.cos(3.11129774897303*s)) - 9.85806810437636*np.cos(np.sin(s)) + 2.05028051349439*np.tanh(np.acos(s)) - 9.85806810437636*np.asin(np.cos(s)) - 2.05028051349439*np.asin((np.sech(np.tanh(np.cos(14.7529124664426*s))))) - 2.05028051349439*(np.sech(s*np.sin(s))) + 13.0755347870728
