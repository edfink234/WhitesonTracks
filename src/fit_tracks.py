...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset_only:
        ...
        eps = .02
        w = 0.28
        plot_func =       -2.06733016081209*s**(1/4) + 1.38363205635325*sp.sqrt(s) - s**2*(s - 0.505614791036285)*(6.10655721549551*s - 6.07383208968989)*(3.23982957025605*s - sp.sin(30.4050477500066*s) - 1.84133915784293)*sp.sin(128.229040348727*s + 14.8127547645076*sp.tanh(s) - 0.688702558659807) + (3*s + 1.69090538771329)*(s - sp.asin(s) + 0.308505541226156)*sp.asin(s) + (2*s*(s**2*sp.asin(s) + 0.296674061725209)*(4*sp.acos(s) - 3.03102696604258)*sp.sin(3.13320097487757*s)*sp.cos(49.6016134939281*sp.acos(s)) - 1.2783007222875)*(-s + sp.acos(s) + 0.602259361135256) + 2.06733016081209*(sp.sqrt(1 - sp.sin(5.46069308055838*s)**2) + (sp.asin(0.162023416558629*s) + 0.763861516990297)*(15.9966126844263*sp.sin(5.38484588599688*s) - 5.37824955335883*sp.sin(9.81799848956101*s) - 13.1596876680223*sp.sin(13.4000533974842*s) + sp.cos(32.9690359373047*s)) - 0.161252917546844*sp.sin(26.7019167669519*sp.acos(s)) - 0.334317141983184*sp.cos(92.475900215986*sp.cos(s)))*sp.cos(0.508090324180722*sp.cos(3.13656065983025*s)) + sp.tanh(sp.sqrt(s)) - 0.303776120878578*sp.acos(-sp.asin(sp.asin(sp.acos(s)**(1/16) - sp.sqrt(sp.acos(s))))) - 2.06733016081209*sp.asin((sp.sech(sp.tanh(sp.cos(14.7416061068815*s))))) - 1.95733408474979 if fitPlotFunc else lambda s: -2.06733016081209*s**(1/4) + 1.38363205635325*np.sqrt(s) - s**2*(s - 0.505614791036285)*(6.10655721549551*s - 6.07383208968989)*(3.23982957025605*s - np.sin(30.4050477500066*s) - 1.84133915784293)*np.sin(128.229040348727*s + 14.8127547645076*np.tanh(s) - 0.688702558659807) + (3*s + 1.69090538771329)*(s - np.asin(s) + 0.308505541226156)*np.asin(s) + (2*s*(s**2*np.asin(s) + 0.296674061725209)*(4*np.acos(s) - 3.03102696604258)*np.sin(3.13320097487757*s)*np.cos(49.6016134939281*np.acos(s)) - 1.2783007222875)*(-s + np.acos(s) + 0.602259361135256) + 2.06733016081209*(np.sqrt(1 - np.sin(5.46069308055838*s)**2) + (np.asin(0.162023416558629*s) + 0.763861516990297)*(15.9966126844263*np.sin(5.38484588599688*s) - 5.37824955335883*np.sin(9.81799848956101*s) - 13.1596876680223*np.sin(13.4000533974842*s) + np.cos(32.9690359373047*s)) - 0.161252917546844*np.sin(26.7019167669519*np.acos(s)) - 0.334317141983184*np.cos(92.475900215986*np.cos(s)))*np.cos(0.508090324180722*np.cos(3.13656065983025*s)) + np.tanh(np.sqrt(s)) - 0.303776120878578*np.acos(-np.asin(np.asin(np.acos(s)**(1/16) - np.sqrt(np.acos(s))))) - 2.06733016081209*np.asin((np.sech(np.tanh(np.cos(14.7416061068815*s))))) - 1.95733408474979
