...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    def create_stubborn_track_dataset(
        ...
        if show:
            ...
            s_vals = np.linspace(s_data.min(), s_data.max(), 100000)
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func =  -0.054900320332509*s*sp.sin(0.262783179800533*s) - 1.11991019443818*s*sp.sin(s + 0.511002747250793)*(1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))) - 0.355450780660288*s*sp.tanh(sp.sin(1.08967676893512*sp.sqrt(s))) + 8.23038896018628*(3.38808914385082 - 8.1723006650769e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 6.59440330892957*(2*s - 0.264389132706502)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0402588826737863) + sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.56380750625584*sp.sin(0.367879441171442*s) + 1.51404571043923*sp.sin(0.713731637960093*s) + 1.51404571043923*sp.sin(0.652036946264407*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + sp.sin(1.02133330848657*s*sp.sin(0.999844360185789*s)) + sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + 2.47656228032836*sp.sin(0.451582705289455*s - 0.386759387350059) - sp.sin(0.631449858567625*s + 0.434801049722095) - sp.sin(sp.sin(1.01441200219495*sp.sqrt(s) + 1.01441200219495*s)) - 8.23038896018628*sp.cos(0.184501965675006*s) + 1.51404571043923*sp.cos(0.859238155913655*s) + sp.cos(1.52297301362374*s**2) + sp.cos(s*(1.59687362463032 - s)) + sp.cos(s*(2*s + 0.258012275465596)) + sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.51404571043923*sp.cos(0.956994426515978*s + 0.723941091202291) - sp.cos(sp.cos(1.41588210657922*s*sp.sqrt(s + 0.604307210566622))) + 0.335119727652645*sp.tanh(s*sp.cos(4*s)) + sp.tanh(sp.cos(5.00420342832107*s)) + sp.tanh(sp.cos(s**(5/4))) + sp.tanh(sp.cos(sp.sqrt(s)*sp.sin(s + 0.676067862627105))) + sp.tanh(sp.cos(s*(1.00010635933952*s + 0.0366189934736865))) - 0.402629378238149*sp.acos(sp.sin(0.765267107370348*s)) + 2.47656228032836*sp.acos(sp.sin(0.517512499805315*s + 0.576723612700042)) + 1.51404571043923*sp.asin(sp.cos(0.25*s)) + 1.51404571043923*sp.asin(sp.cos(0.26580222883408*s)) + 1.51404571043923*sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(0.982609775472489*sp.sqrt(s) + 0.982609775472489*s)) - 1.79805147990019 if fitPlotFunc else lambda s: -0.054900320332509*s*np.sin(0.262783179800533*s) - 1.11991019443818*s*np.sin(s + 0.511002747250793)*(1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))) - 0.355450780660288*s*np.tanh(np.sin(1.08967676893512*np.sqrt(s))) + 8.23038896018628*(3.38808914385082 - 8.1723006650769e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 6.59440330892957*(2*s - 0.264389132706502)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0402588826737863) + np.sin(np.sqrt(s))*np.cos(2*s) - 5.56380750625584*np.sin(0.367879441171442*s) + 1.51404571043923*np.sin(0.713731637960093*s) + 1.51404571043923*np.sin(0.652036946264407*np.sqrt(s)*np.sin(np.sqrt(s))) + np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + np.sin(1.02133330848657*s*np.sin(0.999844360185789*s)) + np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + 2.47656228032836*np.sin(0.451582705289455*s - 0.386759387350059) - np.sin(0.631449858567625*s + 0.434801049722095) - np.sin(np.sin(1.01441200219495*np.sqrt(s) + 1.01441200219495*s)) - 8.23038896018628*np.cos(0.184501965675006*s) + 1.51404571043923*np.cos(0.859238155913655*s) + np.cos(1.52297301362374*s**2) + np.cos(s*(1.59687362463032 - s)) + np.cos(s*(2*s + 0.258012275465596)) + np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.51404571043923*np.cos(0.956994426515978*s + 0.723941091202291) - np.cos(np.cos(1.41588210657922*s*np.sqrt(s + 0.604307210566622))) + 0.335119727652645*np.tanh(s*np.cos(4*s)) + np.tanh(np.cos(5.00420342832107*s)) + np.tanh(np.cos(s**(5/4))) + np.tanh(np.cos(np.sqrt(s)*np.sin(s + 0.676067862627105))) + np.tanh(np.cos(s*(1.00010635933952*s + 0.0366189934736865))) - 0.402629378238149*np.acos(np.sin(0.765267107370348*s)) + 2.47656228032836*np.acos(np.sin(0.517512499805315*s + 0.576723612700042)) + 1.51404571043923*np.asin(np.cos(0.25*s)) + 1.51404571043923*np.asin(np.cos(0.26580222883408*s)) + 1.51404571043923*np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(0.982609775472489*np.sqrt(s) + 0.982609775472489*s)) - 1.79805147990019

        plot_func_eqn = r"$z(s) = - 0.06\cdot s\cdot \sin{\left(0.26\cdot s \right)} - s\cdot \sin{\left(s + 0.52 \right)}\cdot \operatorname{sech}{\left(3.57\cdot s - 425 \right)} - 0.35\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + 6.58\cdot \left(2\cdot s - 0.24\right)\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) + \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.54\cdot \sin{\left(0.37\cdot s \right)} + 1.66\cdot \sin{\left(0.71\cdot s \right)} + 1.66\cdot \sin{\left(0.66\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} - \sin{\left(1.01\cdot \sqrt{s} + 1.01\cdot s \right)} + 27.982\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.48\cdot \sin{\left(0.45\cdot s - 0.38 \right)} - \sin{\left(0.63\cdot s + 0.39 \right)} - 8.23\cdot \cos{\left(0.18\cdot s \right)} + 1.66\cdot \cos{\left(0.27\cdot s \right)} + 1.66\cdot \cos{\left(0.86\cdot s \right)} + \cos{\left(1.52\cdot s^{2} \right)} + \cos{\left(s\cdot \left(1.6 - s\right) \right)} + \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} + \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.66\cdot \cos{\left(0.96\cdot s + 0.74 \right)} + 0.55\cdot \tanh{\left(\sin{\left(0.77\cdot s \right)} \right)} + \tanh{\left(\cos{\left(5.0\cdot s \right)} \right)} + \tanh{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} + \tanh{\left(\cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.67 \right)} \right)} \right)} + \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} + 2.48\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.56 \right)} \right)} + 1.66\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.66\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} - 3.26$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
