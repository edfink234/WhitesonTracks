...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset_only:
        ...
        eps = .02
        w = 0.28
        plot_func =     -s*(-s*(3.88365470449514e-7*s*(sp.sech(sp.cos(sp.sqrt(s)))) - 7.81871564723424e-5) - 0.00260537062787547)*sp.sin(s)*sp.asin(sp.cos(s*(sp.sech(sp.tanh(s))) - 0.756802495307928)) + 12.9570229390743*s*(sp.sqrt((sp.sech(s))) - 0.0412352518417774) - 0.0528447720482914*s*sp.sin(0.262783179800533*s) - 1.39354257484557*s*sp.sin(s + 0.484311792893777)*(sp.sech(3.57142857142857*s - 425)) + 0.00804096255023509*s*sp.cos(0.429203673205103*s**2 + 0.594075261899374) - 0.354781156147373*s*sp.tanh(sp.sin(1.08959504574587*sp.sqrt(s))) + 8.08279816031321*(3.42866504517894 - 8.17051658774659e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) - (-0.00182046900716881*s - (-0.531677337704049*sp.sin(s)*sp.cos(sp.sqrt(s)) - 0.531677337704049*sp.cos(s) - 0.0235022495505362)*sp.sin(s))*sp.cos(0.856996688691341*s - 0.322806427311516) + (0.00133480280550277*s - sp.asin(0.0524369375026477*(-sp.cos(s) + sp.tanh(s))*sp.asin(sp.tanh(s)) + 0.0524369375026477*sp.sin(s**2) - 0.0524369375026477*sp.cos(s**2)))*sp.sin(s) - 0.643021878478269*(s - 3.84104811871141)*(-s*sp.cos(s) - sp.sin(s) - 0.607440854938994)*(sp.sech(0.371435670950793*s)) + (-(0.000774642772674805*s - 0.195675811691331)*(-0.00868589887150603*s - sp.sin(sp.sqrt(s)) - 0.404980920422988*sp.sin(s) - sp.cos(s) + sp.tanh(s) + 0.392530828064809)*sp.cos(4*s + sp.sin(2*s)) - 0.075550772349475)*sp.acos(-sp.cos(s)) + (0.416706689429617*sp.sqrt(1 - sp.cos(s)**2) - 0.416706689429617*sp.tanh(s))*sp.sin(-0.26580222883408*sp.sqrt(s) + s*sp.asin(sp.tanh(s)) + sp.asin(sp.cos(0.0751360908983532*s*(s + 0.0751360908983532)))) - (-0.814537945627312*sp.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) - 0.327576582481555)*sp.cos(s) - (0.574917033720879*sp.cos(s) + 0.39210575821766)*sp.sin(s*(0.873222977060686 - 0.888385561585661*s)) + ((sp.sech(sp.sin((0.0765002140608773 - s)*sp.tanh(sp.tanh(s))))) - (sp.sech(sp.asin(sp.cos(0.90690164698295*s + 0.459861281860669)))))*(-2.3736544334883*sp.sin(s) + 2.3736544334883*sp.tanh(s) - 0.712944712826721) + 0.868204852937739*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.61679521626929*sp.sin(0.367879441171442*s) + 1.49272029147963*sp.sin(0.713731637960093*s) - 0.264373013056633*sp.sin(s)**2*sp.sin(1.07250742738533*sp.sqrt(-s*(-sp.sqrt(s) - 0.497473708504806))) + 1.49272029147963*sp.sin(0.639132796686276*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.868204852937739*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.868204852937739*sp.sin(1.01906356938416*s*sp.sin(0.999857337167407*s)) + 0.868204852937739*sp.sin(s*sp.cos((sp.sech(0.0136985281801015*s)))) - 0.0840979658538013*sp.sin(s*sp.tanh(sp.sin(s) - 0.0751360908983532))*sp.cos(s) + 0.123078871297108*sp.sin(s**2*sp.cos(sp.cos(s))) - 0.237140870305564*sp.sin(sp.sqrt(sp.Abs(s**2*(2*s - 0.939931469880348)))*sp.sin(s)) + 2.42524545967496*sp.sin(0.451582705289455*s - 0.365159782650125) - 0.868204852937739*sp.sin(0.631449858567625*s + 0.419425530962709) + 0.106422444476085*sp.sin(s*(sp.sin(s) + (sp.sech(s))) - s) + 0.868204852937739*sp.sin(sp.cos(s**(5/4))) - 0.188255609691216*sp.cos(sp.sqrt(s))*sp.cos(3*s + sp.sin(sp.sqrt(s)) + 0.247183038887704) - 8.08279816031321*sp.cos(0.184501965675006*s) + 1.49272029147963*sp.cos(0.859238155913655*s) - sp.cos(s)*sp.acos(sp.sin(sp.cos(sp.sin(1.97493799097939*s)))) + 0.310413401052111*sp.cos(1.44312628154549*s) - 0.120261794591226*sp.cos(s**2)*sp.asin(sp.sin(s + sp.tanh(sp.sin(s) + (sp.sech(s))))*sp.cos(sp.sqrt(s))) + 0.868204852937739*sp.cos(1.52297301362374*s**2) + 0.868204852937739*sp.cos(sp.sqrt(s)*sp.sin(s + 0.700783089090742)) + 0.868204852937739*sp.cos(s*(1.59822650980331 - s)) + 0.868204852937739*sp.cos(s*(2*s + 0.258012275465596)) - 0.310034292330473*sp.cos(s*(1.00300385903529*sp.sin(s) + 1.91878516265159)) + 0.868204852937739*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 0.41420005588878*sp.cos(1.10583897256825*s*(-(sp.sech(s)) - sp.sqrt((sp.sech(sp.sin(s)))) + 0.705026843555238)) + 1.49272029147963*sp.cos(0.956994426515978*s + 0.69851369566006) + sp.cos(sp.sin(1.41588210657922*s*sp.sqrt(s + 0.604307210566622))) - 0.868204852937739*sp.tanh(sp.sin(1.01601732983085*sp.sqrt(s) + 1.01601732983085*s)) + sp.tanh(sp.cos(s)) + 0.868204852937739*sp.tanh(sp.cos(5.00420342832107*s)) + 0.868204852937739*sp.tanh(sp.cos(s*(1.00012530357858*s + 0.0366189934736865))) - 0.507258993792591*sp.acos(sp.sin(0.765267107370348*s)) + 2.42524545967496*sp.acos(sp.sin(0.517512499805315*s + 0.492990362862465)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.933388893411544))) + sp.asin(0.122695961260996*sp.sin(sp.sqrt(s) + s*(s**(1/4) - sp.sqrt(s)) - 0.513662912547222)) + 1.49272029147963*sp.asin(sp.cos(0.25*s)) + 1.49272029147963*sp.asin(sp.cos(0.26580222883408*s)) + 1.49272029147963*sp.asin(sp.cos(0.594932778023209*s)) + 0.27552651140119*sp.asin(sp.cos(s*(s + 0.26580222883408))) - 0.25983931135938*sp.asin(sp.cos((s + 0.356921100186546)*(0.654182574305564*sp.cos(s) + 2))) + 0.868204852937739*sp.asin(sp.cos(0.982891779992106*sp.sqrt(s) + 0.982891779992106*s)) + sp.asin((sp.sech(3.30223403023902*sp.sin(s)))) - 3.07014303801286 if fitPlotFunc else lambda s: -s*(-s*(3.88365470449514e-7*s*(np.sech(np.cos(np.sqrt(s)))) - 7.81871564723424e-5) - 0.00260537062787547)*np.sin(s)*np.asin(np.cos(s*(np.sech(np.tanh(s))) - 0.756802495307928)) + 12.9570229390743*s*(np.sqrt((np.sech(s))) - 0.0412352518417774) - 0.0528447720482914*s*np.sin(0.262783179800533*s) - 1.39354257484557*s*np.sin(s + 0.484311792893777)*(np.sech(3.57142857142857*s - 425)) + 0.00804096255023509*s*np.cos(0.429203673205103*s**2 + 0.594075261899374) - 0.354781156147373*s*np.tanh(np.sin(1.08959504574587*np.sqrt(s))) + 8.08279816031321*(3.42866504517894 - 8.17051658774659e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) - (-0.00182046900716881*s - (-0.531677337704049*np.sin(s)*np.cos(np.sqrt(s)) - 0.531677337704049*np.cos(s) - 0.0235022495505362)*np.sin(s))*np.cos(0.856996688691341*s - 0.322806427311516) + (0.00133480280550277*s - np.asin(0.0524369375026477*(-np.cos(s) + np.tanh(s))*np.asin(np.tanh(s)) + 0.0524369375026477*np.sin(s**2) - 0.0524369375026477*np.cos(s**2)))*np.sin(s) - 0.643021878478269*(s - 3.84104811871141)*(-s*np.cos(s) - np.sin(s) - 0.607440854938994)*(np.sech(0.371435670950793*s)) + (-(0.000774642772674805*s - 0.195675811691331)*(-0.00868589887150603*s - np.sin(np.sqrt(s)) - 0.404980920422988*np.sin(s) - np.cos(s) + np.tanh(s) + 0.392530828064809)*np.cos(4*s + np.sin(2*s)) - 0.075550772349475)*np.acos(-np.cos(s)) + (0.416706689429617*np.sqrt(1 - np.cos(s)**2) - 0.416706689429617*np.tanh(s))*np.sin(-0.26580222883408*np.sqrt(s) + s*np.asin(np.tanh(s)) + np.asin(np.cos(0.0751360908983532*s*(s + 0.0751360908983532)))) - (-0.814537945627312*np.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) - 0.327576582481555)*np.cos(s) - (0.574917033720879*np.cos(s) + 0.39210575821766)*np.sin(s*(0.873222977060686 - 0.888385561585661*s)) + ((np.sech(np.sin((0.0765002140608773 - s)*np.tanh(np.tanh(s))))) - (np.sech(np.asin(np.cos(0.90690164698295*s + 0.459861281860669)))))*(-2.3736544334883*np.sin(s) + 2.3736544334883*np.tanh(s) - 0.712944712826721) + 0.868204852937739*np.sin(np.sqrt(s))*np.cos(2*s) - 5.61679521626929*np.sin(0.367879441171442*s) + 1.49272029147963*np.sin(0.713731637960093*s) - 0.264373013056633*np.sin(s)**2*np.sin(1.07250742738533*np.sqrt(-s*(-np.sqrt(s) - 0.497473708504806))) + 1.49272029147963*np.sin(0.639132796686276*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.868204852937739*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.868204852937739*np.sin(1.01906356938416*s*np.sin(0.999857337167407*s)) + 0.868204852937739*np.sin(s*np.cos((np.sech(0.0136985281801015*s)))) - 0.0840979658538013*np.sin(s*np.tanh(np.sin(s) - 0.0751360908983532))*np.cos(s) + 0.123078871297108*np.sin(s**2*np.cos(np.cos(s))) - 0.237140870305564*np.sin(np.sqrt(np.abs(s**2*(2*s - 0.939931469880348)))*np.sin(s)) + 2.42524545967496*np.sin(0.451582705289455*s - 0.365159782650125) - 0.868204852937739*np.sin(0.631449858567625*s + 0.419425530962709) + 0.106422444476085*np.sin(s*(np.sin(s) + (np.sech(s))) - s) + 0.868204852937739*np.sin(np.cos(s**(5/4))) - 0.188255609691216*np.cos(np.sqrt(s))*np.cos(3*s + np.sin(np.sqrt(s)) + 0.247183038887704) - 8.08279816031321*np.cos(0.184501965675006*s) + 1.49272029147963*np.cos(0.859238155913655*s) - np.cos(s)*np.acos(np.sin(np.cos(np.sin(1.97493799097939*s)))) + 0.310413401052111*np.cos(1.44312628154549*s) - 0.120261794591226*np.cos(s**2)*np.asin(np.sin(s + np.tanh(np.sin(s) + (np.sech(s))))*np.cos(np.sqrt(s))) + 0.868204852937739*np.cos(1.52297301362374*s**2) + 0.868204852937739*np.cos(np.sqrt(s)*np.sin(s + 0.700783089090742)) + 0.868204852937739*np.cos(s*(1.59822650980331 - s)) + 0.868204852937739*np.cos(s*(2*s + 0.258012275465596)) - 0.310034292330473*np.cos(s*(1.00300385903529*np.sin(s) + 1.91878516265159)) + 0.868204852937739*np.cos(s*(np.asin(np.cos(s)) + 2)) + 0.41420005588878*np.cos(1.10583897256825*s*(-(np.sech(s)) - np.sqrt((np.sech(np.sin(s)))) + 0.705026843555238)) + 1.49272029147963*np.cos(0.956994426515978*s + 0.69851369566006) + np.cos(np.sin(1.41588210657922*s*np.sqrt(s + 0.604307210566622))) - 0.868204852937739*np.tanh(np.sin(1.01601732983085*np.sqrt(s) + 1.01601732983085*s)) + np.tanh(np.cos(s)) + 0.868204852937739*np.tanh(np.cos(5.00420342832107*s)) + 0.868204852937739*np.tanh(np.cos(s*(1.00012530357858*s + 0.0366189934736865))) - 0.507258993792591*np.acos(np.sin(0.765267107370348*s)) + 2.42524545967496*np.acos(np.sin(0.517512499805315*s + 0.492990362862465)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.933388893411544))) + np.asin(0.122695961260996*np.sin(np.sqrt(s) + s*(s**(1/4) - np.sqrt(s)) - 0.513662912547222)) + 1.49272029147963*np.asin(np.cos(0.25*s)) + 1.49272029147963*np.asin(np.cos(0.26580222883408*s)) + 1.49272029147963*np.asin(np.cos(0.594932778023209*s)) + 0.27552651140119*np.asin(np.cos(s*(s + 0.26580222883408))) - 0.25983931135938*np.asin(np.cos((s + 0.356921100186546)*(0.654182574305564*np.cos(s) + 2))) + 0.868204852937739*np.asin(np.cos(0.982891779992106*np.sqrt(s) + 0.982891779992106*s)) + np.asin((np.sech(3.30223403023902*np.sin(s)))) - 3.07014303801286
