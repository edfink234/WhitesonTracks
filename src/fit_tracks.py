...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func = s*(0.000486860658922442 - (1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))))*sp.sin(s + 0.516528566946533) - 0.056400379739193*s*sp.sin(0.262783179800533*s) - 0.354504621679578*s*sp.tanh(sp.sin(1.08977293020115*sp.sqrt(s))) + 8.22613795556468*(3.4032661087091 - 8.32874019862651e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 6.5808830209284*(2*s - 0.243294640787617)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0402588826737863) + sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.54454591079323*sp.sin(0.367879441171442*s) + 1.65649481952774*sp.sin(0.713731637960093*s) + 1.65649481952774*sp.sin(0.657681284007411*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + sp.sin(1.02133330848657*s*sp.sin(0.999847713730188*s)) + sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) - sp.sin(1.01477825492802*sp.sqrt(s) + 1.01477825492802*s) + 2.47528313328558*sp.sin(0.451582705289455*s - 0.376063505821862) - sp.sin(0.631449858567625*s + 0.391977973700407) - 8.22613795556468*sp.cos(0.184501965675006*s) + 1.65649481952774*sp.cos(0.26580222883408*s) + 1.65649481952774*sp.cos(0.859238155913655*s) + sp.cos(1.52297301362374*s**2) + sp.cos(s*(1.59687362463032 - s)) + sp.cos(s*(2*s + 0.258012275465596)) + sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.65649481952774*sp.cos(0.956994426515978*s + 0.737232674188113) + 0.549198987917026*sp.tanh(sp.sin(0.765267107370348*s)) + sp.tanh(sp.cos(5.00357894058862*s)) + sp.tanh(sp.cos(s**(5/4))) + sp.tanh(sp.cos(sp.sqrt(s)*sp.sin(s + 0.669678653296829))) + sp.tanh(sp.cos(s*(1.00009542608281*s + 0.0366189934736865))) + 2.47528313328558*sp.acos(sp.sin(0.517512499805315*s + 0.563646211474924)) + 1.65649481952774*sp.asin(sp.cos(0.25*s)) + 1.65649481952774*sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(0.983048710701195*sp.sqrt(s) + 0.983048710701195*s)) - 3.25970448855428 if fitPlotFunc else lambda s: s*(0.000486860658922442 - (1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))))*np.sin(s + 0.516528566946533) - 0.056400379739193*s*np.sin(0.262783179800533*s) - 0.354504621679578*s*np.tanh(np.sin(1.08977293020115*np.sqrt(s))) + 8.22613795556468*(3.4032661087091 - 8.32874019862651e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 6.5808830209284*(2*s - 0.243294640787617)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0402588826737863) + np.sin(np.sqrt(s))*np.cos(2*s) - 5.54454591079323*np.sin(0.367879441171442*s) + 1.65649481952774*np.sin(0.713731637960093*s) + 1.65649481952774*np.sin(0.657681284007411*np.sqrt(s)*np.sin(np.sqrt(s))) + np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + np.sin(1.02133330848657*s*np.sin(0.999847713730188*s)) + np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) - np.sin(1.01477825492802*np.sqrt(s) + 1.01477825492802*s) + 2.47528313328558*np.sin(0.451582705289455*s - 0.376063505821862) - np.sin(0.631449858567625*s + 0.391977973700407) - 8.22613795556468*np.cos(0.184501965675006*s) + 1.65649481952774*np.cos(0.26580222883408*s) + 1.65649481952774*np.cos(0.859238155913655*s) + np.cos(1.52297301362374*s**2) + np.cos(s*(1.59687362463032 - s)) + np.cos(s*(2*s + 0.258012275465596)) + np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.65649481952774*np.cos(0.956994426515978*s + 0.737232674188113) + 0.549198987917026*np.tanh(np.sin(0.765267107370348*s)) + np.tanh(np.cos(5.00357894058862*s)) + np.tanh(np.cos(s**(5/4))) + np.tanh(np.cos(np.sqrt(s)*np.sin(s + 0.669678653296829))) + np.tanh(np.cos(s*(1.00009542608281*s + 0.0366189934736865))) + 2.47528313328558*np.acos(np.sin(0.517512499805315*s + 0.563646211474924)) + 1.65649481952774*np.asin(np.cos(0.25*s)) + 1.65649481952774*np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(0.983048710701195*np.sqrt(s) + 0.983048710701195*s)) - 3.25970448855428
