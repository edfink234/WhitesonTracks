...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        plot_func = 12.4326776570732*s*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0431435752765961) - 0.0601689531091251*s*sp.sin(0.262783179800533*s) - 0.349515990228487*s*sp.tanh(sp.sin(1.0905431366872*sp.sqrt(s))) + 7.78790596738267*(3.57400545532741 - 8.47504690566225e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) - 5.6467786314184*sp.sin(0.367879441171442*s) + 1.72155527043459*sp.sin(0.713731637960093*s) + 1.72155527043459*sp.sin(0.649289832853792*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + sp.sin((-s - 0.568101919500109)*(sp.tanh(s) - 0.367879441171442)) + 2.39163641564301*sp.sin(0.451582705289455*s - 0.305830651789604) - 7.78790596738267*sp.cos(0.184501965675006*s) + 1.72155527043459*sp.cos(0.859238155913655*s) + sp.cos(s*(1.59709787998252 - s)) + sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.72155527043459*sp.cos(0.956994426515978*s + 0.894316123398857) + 1.72155527043459*sp.tanh(sp.cos(0.26580222883408*s)) + 2.39163641564301*sp.acos(sp.sin(0.517512499805315*s + 0.71189191833423)) + 1.72155527043459*sp.asin(sp.cos(0.25*s)) + 1.72155527043459*sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(0.983488142024586*sp.sqrt(s) + 0.983488142024586*s)) - 2.44802962438794 if fitPlotFunc else lambda s: 12.4326776570732*s*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0431435752765961) - 0.0601689531091251*s*np.sin(0.262783179800533*s) - 0.349515990228487*s*np.tanh(np.sin(1.0905431366872*np.sqrt(s))) + 7.78790596738267*(3.57400545532741 - 8.47504690566225e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) - 5.6467786314184*np.sin(0.367879441171442*s) + 1.72155527043459*np.sin(0.713731637960093*s) + 1.72155527043459*np.sin(0.649289832853792*np.sqrt(s)*np.sin(np.sqrt(s))) + np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + np.sin((-s - 0.568101919500109)*(np.tanh(s) - 0.367879441171442)) + 2.39163641564301*np.sin(0.451582705289455*s - 0.305830651789604) - 7.78790596738267*np.cos(0.184501965675006*s) + 1.72155527043459*np.cos(0.859238155913655*s) + np.cos(s*(1.59709787998252 - s)) + np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.72155527043459*np.cos(0.956994426515978*s + 0.894316123398857) + 1.72155527043459*np.tanh(np.cos(0.26580222883408*s)) + 2.39163641564301*np.acos(np.sin(0.517512499805315*s + 0.71189191833423)) + 1.72155527043459*np.asin(np.cos(0.25*s)) + 1.72155527043459*np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(0.983488142024586*np.sqrt(s) + 0.983488142024586*s)) - 2.44802962438794


        plot_func_eqn = r"$z(s) = 12.43\cdot s\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) - 0.06\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 0.35\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} - 5.65\cdot \sin{\left(0.37\cdot s \right)} + 1.72\cdot \sin{\left(0.71\cdot s \right)} + 1.72\cdot \sin{\left(0.65\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + \sin{\left(\left(- s - 0.57\right)\cdot \left(\tanh{\left(s \right)} - 0.37\right) \right)} + 27.8103\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.39\cdot \sin{\left(0.45\cdot s - 0.31 \right)} - 7.79\cdot \cos{\left(0.18\cdot s \right)} + 1.72\cdot \cos{\left(0.86\cdot s \right)} + \cos{\left(s\cdot \left(1.6 - s\right) \right)} + \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.72\cdot \cos{\left(0.96\cdot s + 0.89 \right)} + 1.72\cdot \tanh{\left(\cos{\left(0.27\cdot s \right)} \right)} + 2.39\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.71 \right)} \right)} + 1.72\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.72\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} - 2.45$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
