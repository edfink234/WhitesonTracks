...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        plot_func = -0.0531560188395763*s*sp.sin(0.262783179800533*s) - 0.347691319430833*s*sp.tanh(sp.sin(1.09137947860194*sp.sqrt(s))) + 7.51861056279194*(3.70410847113999 - 8.86444240455475e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 5.21211841839248*(2*s + 0.954681840269459)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0509488398540936) - 5.20669723620354*sp.sin(0.367879441171442*s) - sp.sin(0.529667341874463*s) - sp.sin(0.634727187009155*s) + 1.44592026781344*sp.sin(0.713731637960093*s) + sp.sin(0.639104769362927*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 2.94696941909083*sp.sin(0.451582705289455*s - 0.300327854374319) - 7.51861056279194*sp.cos(0.184501965675006*s) + sp.cos(0.962431954550823*s + 0.451516181294573) + sp.acos(sp.sin(0.517512499805315*s + 0.712094125236824)) + sp.asin(sp.cos(0.25*s)) + sp.asin(sp.cos(0.26580222883408*s)) + sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(0.859238155913655*s)) - 0.453739978031602 if fitPlotFunc else lambda s: -0.0531560188395763*s*np.sin(0.262783179800533*s) - 0.347691319430833*s*np.tanh(np.sin(1.09137947860194*np.sqrt(s))) + 7.51861056279194*(3.70410847113999 - 8.86444240455475e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 5.21211841839248*(2*s + 0.954681840269459)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0509488398540936) - 5.20669723620354*np.sin(0.367879441171442*s) - np.sin(0.529667341874463*s) - np.sin(0.634727187009155*s) + 1.44592026781344*np.sin(0.713731637960093*s) + np.sin(0.639104769362927*np.sqrt(s)*np.sin(np.sqrt(s))) + 2.94696941909083*np.sin(0.451582705289455*s - 0.300327854374319) - 7.51861056279194*np.cos(0.184501965675006*s) + np.cos(0.962431954550823*s + 0.451516181294573) + np.acos(np.sin(0.517512499805315*s + 0.712094125236824)) + np.asin(np.cos(0.25*s)) + np.asin(np.cos(0.26580222883408*s)) + np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(0.859238155913655*s)) - 0.453739978031602


        plot_func_eqn = r"$z(s) = - 0.05\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 0.35\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + 5.21\cdot \left(2\cdot s + 0.95\right)\cdot \left(\sqrt{\mathrm{sech}{\left(s \right)}} - 0.05\right) - 5.21\cdot \sin{\left(0.37\cdot s \right)} - \sin{\left(0.53\cdot s \right)} - \sin{\left(0.63\cdot s \right)} + 1.45\cdot \sin{\left(0.71\cdot s \right)} + \sin{\left(0.64\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + 27.824\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)}$""\n"r"$+ 2.95\cdot \sin{\left(0.45\cdot s - 0.3 \right)} - 7.52\cdot \cos{\left(0.18\cdot s \right)} + \cos{\left(0.96\cdot s + 0.45 \right)} + \mathrm{acos}{\left(\sin{\left(0.52\cdot s + 0.71 \right)} \right)} + \mathrm{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + \mathrm{asin}{\left(\cos{\left(0.27\cdot s \right)} \right)} + \mathrm{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + \mathrm{asin}{\left(\cos{\left(0.86\cdot s \right)} \right)} - 0.45$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
