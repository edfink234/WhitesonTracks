...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func = 13.118813594989*s*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0404333432318705) - 0.0573128616210911*s*sp.sin(0.262783179800533*s) - 0.353307081581772*s*sp.tanh(sp.sin(1.0903039942843*sp.sqrt(s))) + 8.06772263094343*(3.45447131181834 - 8.32874019862651e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.50339967848706*sp.sin(0.367879441171442*s) + 1.65600148666407*sp.sin(0.713731637960093*s) + 1.65600148666407*sp.sin(0.662038516856432*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + sp.sin(1.01640160711561*s*sp.sin(0.999872752073094*s)) + sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + sp.sin((-s - 0.587183585038599)*(sp.tanh(s) - 0.367879441171442)) - sp.sin(1.01721225591432*sp.sqrt(s) + 1.01721225591432*s) + 2.49989249566186*sp.sin(0.451582705289455*s - 0.279689740483436) - 1.65600148666407*sp.sin(0.956994426515978*s - 0.649913537788624) - 8.06772263094343*sp.cos(0.184501965675006*s) + 1.65600148666407*sp.cos(0.859238155913655*s) + sp.cos(1.52297301362374*s**2) + sp.cos(s*(1.59670393247583 - s)) + sp.cos(s*(2*s + 0.258012275465596)) + sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.65600148666407*sp.tanh(sp.cos(0.26580222883408*s)) + sp.tanh(sp.cos(1.2834777179177*s)) + sp.tanh(sp.cos(s**(5/4))) + sp.tanh(sp.cos(sp.sqrt(s)*sp.sin(s + 0.666156983417676))) + sp.tanh(sp.cos(s*(1.00006986832848*s + 0.0366189934736865))) + 2.49989249566186*sp.acos(sp.sin(0.517512499805315*s + 0.579323321197033)) + 1.65600148666407*sp.asin(sp.cos(0.25*s)) + 1.65600148666407*sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(0.983073533648321*sp.sqrt(s) + 0.983073533648321*s)) - 3.27990068554088 + 9.28 * sp.sech((s - 118)/w) -13.2 * sp.sech((s - 119)/w) if fitPlotFunc else lambda s: 13.118813594989*s*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0404333432318705) - 0.0573128616210911*s*np.sin(0.262783179800533*s) - 0.353307081581772*s*np.tanh(np.sin(1.0903039942843*np.sqrt(s))) + 8.06772263094343*(3.45447131181834 - 8.32874019862651e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + np.sin(np.sqrt(s))*np.cos(2*s) - 5.50339967848706*np.sin(0.367879441171442*s) + 1.65600148666407*np.sin(0.713731637960093*s) + 1.65600148666407*np.sin(0.662038516856432*np.sqrt(s)*np.sin(np.sqrt(s))) + np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + np.sin(1.01640160711561*s*np.sin(0.999872752073094*s)) + np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + np.sin((-s - 0.587183585038599)*(np.tanh(s) - 0.367879441171442)) - np.sin(1.01721225591432*np.sqrt(s) + 1.01721225591432*s) + 2.49989249566186*np.sin(0.451582705289455*s - 0.279689740483436) - 1.65600148666407*np.sin(0.956994426515978*s - 0.649913537788624) - 8.06772263094343*np.cos(0.184501965675006*s) + 1.65600148666407*np.cos(0.859238155913655*s) + np.cos(1.52297301362374*s**2) + np.cos(s*(1.59670393247583 - s)) + np.cos(s*(2*s + 0.258012275465596)) + np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.65600148666407*np.tanh(np.cos(0.26580222883408*s)) + np.tanh(np.cos(1.2834777179177*s)) + np.tanh(np.cos(s**(5/4))) + np.tanh(np.cos(np.sqrt(s)*np.sin(s + 0.666156983417676))) + np.tanh(np.cos(s*(1.00006986832848*s + 0.0366189934736865))) + 2.49989249566186*np.acos(np.sin(0.517512499805315*s + 0.579323321197033)) + 1.65600148666407*np.asin(np.cos(0.25*s)) + 1.65600148666407*np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(0.983073533648321*np.sqrt(s) + 0.983073533648321*s)) - 3.27990068554088 + 9.28 * np.sech((s - 118)/w) -13.2 * np.sech((s - 119)/w)

        plot_func_eqn = r"$z(s) = 13.12\cdot s\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) - 0.06\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 0.35\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.5\cdot \sin{\left(0.37\cdot s \right)} + 1.66\cdot \sin{\left(0.71\cdot s \right)} + 1.66\cdot \sin{\left(0.66\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} $""\n"r"$+ \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + \sin{\left(\left(- s - 0.59\right)\cdot \left(\tanh{\left(s \right)} - 0.37\right) \right)} - \sin{\left(1.02\cdot \sqrt{s} + 1.02\cdot s \right)} + 27.9222\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.5\cdot \sin{\left(0.45\cdot s - 0.28 \right)} - 1.66\cdot \sin{\left(0.96\cdot s - 0.65 \right)} $""\n"r"$- 8.07\cdot \cos{\left(0.18\cdot s \right)} + 1.66\cdot \cos{\left(0.86\cdot s \right)} + \cos{\left(1.52\cdot s^{2} \right)} + \cos{\left(s\cdot \left(1.6 - s\right) \right)} + \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} + \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.66\cdot \tanh{\left(\cos{\left(0.27\cdot s \right)} \right)} $""\n"r"$+ \tanh{\left(\cos{\left(1.28\cdot s \right)} \right)} + \tanh{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} + \tanh{\left(\cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.67 \right)} \right)} \right)} + \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} + 2.5\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.58 \right)} \right)} + 1.66\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.66\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} - 3.28$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
