...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        plot_func =  -0.058629*s*sp.sin(0.262783179800533*s) - 0.3198878238325*s*sp.sin(sp.sin(1.092289*sp.sqrt(s))) + s + 7.953155*(3.44883 - 9.45154e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 5.18365*(2*s + 1.611181)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.146954) + sp.sin(0.783410418396398*s**(3/4)) - 5.19805*sp.sin(0.367879441171442*s) - sp.sin(0.529667341874463*s) + 1.42325*sp.sin(0.713731637960093*s) + 3.01441*sp.sin(0.451582705289455*s - 0.451582705289455*sp.tanh(s)) - 7.953155*sp.cos(0.184501965675006*s) + sp.asin(sp.cos(0.25*s)) + sp.asin(sp.cos(0.594932778023209*s)) + sp.asin(sp.cos(sp.sqrt(s)*(sp.tanh(s) + 1.5707963267949))) - sp.asin(sp.cos(0.517512499805315*s - 0.779342)) + 1.392000953875 if fitPlotFunc else lambda s: -0.058629*s*np.sin(0.262783179800533*s) - 0.3198878238325*s*np.sin(np.sin(1.092289*np.sqrt(s))) + s + 7.953155*(3.44883 - 9.45154e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 5.18365*(2*s + 1.611181)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.146954) + np.sin(0.783410418396398*s**(3/4)) - 5.19805*np.sin(0.367879441171442*s) - np.sin(0.529667341874463*s) + 1.42325*np.sin(0.713731637960093*s) + 3.01441*np.sin(0.451582705289455*s - 0.451582705289455*np.tanh(s)) - 7.953155*np.cos(0.184501965675006*s) + np.asin(np.cos(0.25*s)) + np.asin(np.cos(0.594932778023209*s)) + np.asin(np.cos(np.sqrt(s)*(np.tanh(s) + 1.5707963267949))) - np.asin(np.cos(0.517512499805315*s - 0.779342)) + 1.392000953875


        plot_func_eqn = r"$z(s) = - 0.06\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 0.32\cdot s\cdot \sin{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + s + 5.18\cdot \left(2\cdot s + 1.61\right)\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.15\right) + \sin{\left(0.78\cdot s^{\frac{3}{4}} \right)} - 5.2\cdot \sin{\left(0.37\cdot s \right)} - \sin{\left(0.53\cdot s \right)} + 1.42\cdot \sin{\left(0.71\cdot s \right)} + 27.4275\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 3.01\cdot \sin{\left(0.45\cdot s - 0.45\cdot \tanh{\left(s \right)} \right)} - 7.95\cdot \cos{\left(0.18\cdot s \right)} + \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + \operatorname{asin}{\left(\cos{\left(\sqrt{s}\cdot \left(\tanh{\left(s \right)} + 1.57\right) \right)} \right)} - \operatorname{asin}{\left(\cos{\left(0.52\cdot s - 0.78 \right)} \right)} + 1.39$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
