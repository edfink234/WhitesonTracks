...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func =    -0.0537607241475189*s*sp.sin(0.262783179800533*s) - 1.48183001985995*s*sp.sin(s + 0.480124848999091)*(1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))) - 0.00475054785645008*s*sp.sin(0.429203673205103*s**2 - 1.0423052320046) - 0.355079702955883*s*sp.tanh(sp.sin(1.08978594419407*sp.sqrt(s))) + 8.11432822130081*(3.42792419546854 - 8.1723006650769e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 0.559836082307438*(s - 3.87296232937303)*(s*sp.cos(s) + sp.sin(s) + 1.03518545721325)*(1/((1/2)*sp.exp(0.371435670950793*s) + (1/2)*sp.exp(-0.371435670950793*s))) + 6.55407343438225*(2*s + 0.134669474785815)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0405089461105445) + (0.7358448226113*sp.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.225156727820593)*sp.cos(s) + (-0.774138367862953*sp.cos(s) - 0.419262672363056)*sp.sin(s*(0.873915548987299 - 0.888385561585661*s)) + (sp.cos(sp.sin((s + 0.0168385841180408)*sp.tanh(sp.tanh(s)))) - (1/((1/2)*sp.exp(sp.asin((1/2)*sp.exp(1j*(-0.906514905500232*s - 0.501570467191284)) + (1/2)*sp.exp(1j*(0.906514905500232*s + 0.501570467191284)))) + (1/2)*sp.exp(-sp.asin((1/2)*sp.exp(1j*(-0.906514905500232*s - 0.501570467191284)) + (1/2)*sp.exp(1j*(0.906514905500232*s + 0.501570467191284)))))))*(-2.00511592444855*sp.sin(s) + 2.00511592444855*sp.tanh(s) - 0.541890123269465) + 0.862591738837396*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.57578551396939*sp.sin(0.367879441171442*s) + 1.49047155727002*sp.sin(0.713731637960093*s) + 1.49047155727002*sp.sin(0.637439071877847*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.862591738837396*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.862591738837396*sp.sin(1.01946699771136*s*sp.sin(0.999857337167407*s)) + 0.862591738837396*sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + 2.43178681674545*sp.sin(0.451582705289455*s - 0.351126985181391) - 0.862591738837396*sp.sin(0.631449858567625*s + 0.392823636025803) + 0.862591738837396*sp.sin(sp.cos(sp.sqrt(s)*sp.sin(s + 0.704613959142765))) - 8.11432822130081*sp.cos(0.184501965675006*s) + 1.49047155727002*sp.cos(0.859238155913655*s) + 0.19505700538959*sp.cos(1.44312628154549*s) + 0.862591738837396*sp.cos(1.52297301362374*s**2) + 0.862591738837396*sp.cos(s*(1.59813251239998 - s)) + 0.862591738837396*sp.cos(s*(2*s + 0.258012275465596)) - 0.27130855902195*sp.cos(s*(1.00648808258642*sp.sin(s) + 1.91878516265159)) + 0.862591738837396*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.49047155727002*sp.cos(0.956994426515978*s + 0.723510666539618) + 0.354872684804778*sp.cos((1.10931452983603*s + (1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s))))*(-(1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s))) - sp.sqrt((1/((1/2)*sp.exp((1/2)*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-1/2*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) + 0.705026843555238) - 0.151998203765287) - 0.862591738837396*sp.tanh(sp.sin(1.01459251596214*sp.sqrt(s) + 1.01459251596214*s)) + 0.862591738837396*sp.tanh(sp.cos(5.00420342832107*s)) + 0.862591738837396*sp.tanh(sp.cos(s**(5/4))) + 0.342053842661102*sp.tanh(sp.cos(s*(s + 0.26580222883408))) + 0.862591738837396*sp.tanh(sp.cos(s*(1.00013788073421*s + 0.0366189934736865))) - 0.433965519473395*sp.acos(sp.sin(0.765267107370348*s)) + 2.43178681674545*sp.acos(sp.sin(0.517512499805315*s + 0.545573566007645)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.794008578822637))) + 1.49047155727002*sp.asin(sp.cos(0.25*s)) + 1.49047155727002*sp.asin(sp.cos(0.26580222883408*s)) + 1.49047155727002*sp.asin(sp.cos(0.594932778023209*s)) + 0.862591738837396*sp.asin(sp.cos(0.983047194673816*sp.sqrt(s) + 0.983047194673816*s)) + sp.asin((1/((1/2)*sp.exp(3.45185385673622*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-3.45185385673622*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) - (1/((1/2)*sp.exp(sp.asin((1/2)*sp.exp(1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)) + (1/2)*sp.exp(-1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)))) + (1/2)*sp.exp(-sp.asin((1/2)*sp.exp(1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)) + (1/2)*sp.exp(-1.41588210657922*1j*s*sp.sqrt(s + 0.604307210566622)))))) - 1.83169906147704 if fitPlotFunc else lambda s: -0.0537607241475189*s*np.sin(0.262783179800533*s) - 1.48183001985995*s*np.sin(s + 0.480124848999091)*(1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))) - 0.00475054785645008*s*np.sin(0.429203673205103*s**2 - 1.0423052320046) - 0.355079702955883*s*np.tanh(np.sin(1.08978594419407*np.sqrt(s))) + 8.11432822130081*(3.42792419546854 - 8.1723006650769e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 0.559836082307438*(s - 3.87296232937303)*(s*np.cos(s) + np.sin(s) + 1.03518545721325)*(1/((1/2)*np.exp(0.371435670950793*s) + (1/2)*np.exp(-0.371435670950793*s))) + 6.55407343438225*(2*s + 0.134669474785815)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0405089461105445) + (0.7358448226113*np.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.225156727820593)*np.cos(s) + (-0.774138367862953*np.cos(s) - 0.419262672363056)*np.sin(s*(0.873915548987299 - 0.888385561585661*s)) + (np.cos(np.sin((s + 0.0168385841180408)*np.tanh(np.tanh(s)))) - (1/((1/2)*np.exp(np.asin((1/2)*np.exp(1j*(-0.906514905500232*s - 0.501570467191284)) + (1/2)*np.exp(1j*(0.906514905500232*s + 0.501570467191284)))) + (1/2)*np.exp(-np.asin((1/2)*np.exp(1j*(-0.906514905500232*s - 0.501570467191284)) + (1/2)*np.exp(1j*(0.906514905500232*s + 0.501570467191284)))))))*(-2.00511592444855*np.sin(s) + 2.00511592444855*np.tanh(s) - 0.541890123269465) + 0.862591738837396*np.sin(np.sqrt(s))*np.cos(2*s) - 5.57578551396939*np.sin(0.367879441171442*s) + 1.49047155727002*np.sin(0.713731637960093*s) + 1.49047155727002*np.sin(0.637439071877847*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.862591738837396*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.862591738837396*np.sin(1.01946699771136*s*np.sin(0.999857337167407*s)) + 0.862591738837396*np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + 2.43178681674545*np.sin(0.451582705289455*s - 0.351126985181391) - 0.862591738837396*np.sin(0.631449858567625*s + 0.392823636025803) + 0.862591738837396*np.sin(np.cos(np.sqrt(s)*np.sin(s + 0.704613959142765))) - 8.11432822130081*np.cos(0.184501965675006*s) + 1.49047155727002*np.cos(0.859238155913655*s) + 0.19505700538959*np.cos(1.44312628154549*s) + 0.862591738837396*np.cos(1.52297301362374*s**2) + 0.862591738837396*np.cos(s*(1.59813251239998 - s)) + 0.862591738837396*np.cos(s*(2*s + 0.258012275465596)) - 0.27130855902195*np.cos(s*(1.00648808258642*np.sin(s) + 1.91878516265159)) + 0.862591738837396*np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.49047155727002*np.cos(0.956994426515978*s + 0.723510666539618) + 0.354872684804778*np.cos((1.10931452983603*s + (1/((1/2)*np.exp(s) + (1/2)*np.exp(-s))))*(-(1/((1/2)*np.exp(s) + (1/2)*np.exp(-s))) - np.sqrt((1/((1/2)*np.exp((1/2)*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-1/2*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) + 0.705026843555238) - 0.151998203765287) - 0.862591738837396*np.tanh(np.sin(1.01459251596214*np.sqrt(s) + 1.01459251596214*s)) + 0.862591738837396*np.tanh(np.cos(5.00420342832107*s)) + 0.862591738837396*np.tanh(np.cos(s**(5/4))) + 0.342053842661102*np.tanh(np.cos(s*(s + 0.26580222883408))) + 0.862591738837396*np.tanh(np.cos(s*(1.00013788073421*s + 0.0366189934736865))) - 0.433965519473395*np.acos(np.sin(0.765267107370348*s)) + 2.43178681674545*np.acos(np.sin(0.517512499805315*s + 0.545573566007645)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.794008578822637))) + 1.49047155727002*np.asin(np.cos(0.25*s)) + 1.49047155727002*np.asin(np.cos(0.26580222883408*s)) + 1.49047155727002*np.asin(np.cos(0.594932778023209*s)) + 0.862591738837396*np.asin(np.cos(0.983047194673816*np.sqrt(s) + 0.983047194673816*s)) + np.asin((1/((1/2)*np.exp(3.45185385673622*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-3.45185385673622*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) - (1/((1/2)*np.exp(np.asin((1/2)*np.exp(1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)) + (1/2)*np.exp(-1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)))) + (1/2)*np.exp(-np.asin((1/2)*np.exp(1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)) + (1/2)*np.exp(-1.41588210657922*1j*s*np.sqrt(s + 0.604307210566622)))))) - 1.83169906147704

        plot_func_eqn = r"$z(s) = - 0.05\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 1.48\cdot s\cdot \sin{\left(s + 0.48 \right)}\cdot \operatorname{sech}{\left(3.57\cdot s - 425 \right)} - 0.36\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + 0.56\cdot \left(s - 3.87\right)\cdot \left(s\cdot \cos{\left(s \right)} + \sin{\left(s \right)} + 1.04\right)\cdot \operatorname{sech}{\left(0.37\cdot s \right)} + 6.55\cdot \left(2\cdot s + 0.13\right)\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) + \left(0.74\cdot \sin{\left(\left(2.59 - s\right)\cdot \left(- s - 0.62\right) \right)} + 0.23\right)\cdot \cos{\left(s \right)} + \left(- 0.77\cdot \cos{\left(s \right)} - 0.42\right)\cdot \sin{\left(s\cdot \left(0.87 - 0.89\cdot s\right) \right)} + \left(\cos{\left(\sin{\left(\left(s + 0.02\right)\cdot \tanh{\left(\tanh{\left(s \right)} \right)} \right)} \right)} - \operatorname{sech}{\left(\operatorname{asin}{\left(\cos{\left(0.91\cdot s + 0.5 \right)} \right)} \right)}\right)\cdot \left(- 2.01\cdot \sin{\left(s \right)} + 2.01\cdot \tanh{\left(s \right)} - 0.54\right) + 0.86\cdot \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.58\cdot \sin{\left(0.37\cdot s \right)} + 1.49\cdot \sin{\left(0.71\cdot s \right)} + 1.49\cdot \sin{\left(0.64\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + 0.86\cdot \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + 27.8173\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.43\cdot \sin{\left(0.45\cdot s - 0.35 \right)} - 0.86\cdot \sin{\left(0.63\cdot s + 0.39 \right)} + 0.86\cdot \sin{\left(\cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.7 \right)} \right)} \right)} - 8.11\cdot \cos{\left(0.18\cdot s \right)} + 1.49\cdot \cos{\left(0.86\cdot s \right)} + 0.2\cdot \cos{\left(1.44\cdot s \right)} + 0.86\cdot \cos{\left(1.52\cdot s^{2} \right)} + 0.86\cdot \cos{\left(s\cdot \left(1.6 - s\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} - 0.27\cdot \cos{\left(s\cdot \left(1.01\cdot \sin{\left(s \right)} + 1.92\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.49\cdot \cos{\left(0.96\cdot s + 0.72 \right)} + 0.35\cdot \cos{\left(\left(1.11\cdot s + \operatorname{sech}{\left(s \right)}\right)\cdot \left(- \operatorname{sech}{\left(s \right)} - \sqrt{\operatorname{sech}{\left(\sin{\left(s \right)} \right)}} + 0.71\right) - 0.15 \right)} - 0.86\cdot \tanh{\left(\sin{\left(1.01\cdot \sqrt{s} + 1.01\cdot s \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(5.0\cdot s \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} + 0.34\cdot \tanh{\left(\cos{\left(s\cdot \left(s + 0.27\right) \right)} \right)} - 0.43\cdot \operatorname{acos}{\left(\sin{\left(0.77\cdot s \right)} \right)} + 2.43\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.55 \right)} \right)} + \operatorname{asin}{\left(0.04\cdot \sqrt{s}\cdot \operatorname{asin}{\left(\cos{\left(0.41\cdot s - 0.41\cdot \cos{\left(s \right)} + 0.79 \right)} \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.27\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + 0.86\cdot \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} + \operatorname{asin}{\left(\operatorname{sech}{\left(6.9\cdot \sin{\left(s \right)} \right)} \right)} - \operatorname{sech}{\left(\operatorname{asin}{\left(\cos{\left(1.42\cdot s\cdot \sqrt{s + 0.6} \right)} \right)} \right)} - 1.83$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
