...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func =   -0.055192322797903*s*sp.sin(0.262783179800533*s) - 1.47367036896874*s*sp.sin(s + 0.481547008279204)*(1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))) - 0.355081236245643*s*sp.tanh(sp.sin(1.08967676893512*sp.sqrt(s))) + 8.20785835154937*(3.40324094855718 - 8.1723006650769e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + 6.59020168992283*(2*s - 0.250338047986874)*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0402588826737863) + (-0.705063707702998*sp.cos(s) - 0.383295880776239)*sp.sin(s*(0.87271603678427 - 0.888385561585661*s)) + 0.858727559696012*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.50083496936074*sp.sin(0.367879441171442*s) + 1.49049429686738*sp.sin(0.713731637960093*s) + 1.49049429686738*sp.sin(0.650863238034514*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.858727559696012*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.858727559696012*sp.sin(1.01990937053213*s*sp.sin(0.999855529823022*s)) + 0.858727559696012*sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + 2.46978271550185*sp.sin(0.451582705289455*s - 0.362934014061473) - 0.858727559696012*sp.sin(0.631449858567625*s + 0.355414129305571) - 0.858727559696012*sp.sin(sp.sin(1.01401579797849*sp.sqrt(s) + 1.01401579797849*s)) - 8.20785835154937*sp.cos(0.184501965675006*s) + 1.49049429686738*sp.cos(0.859238155913655*s) + 0.858727559696012*sp.cos(1.52297301362374*s**2) + 0.858727559696012*sp.cos(s*(1.59692136842694 - s)) + 0.858727559696012*sp.cos(s*(2*s + 0.258012275465596)) + 0.858727559696012*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.49049429686738*sp.cos(0.956994426515978*s + 0.709118088008111) - sp.cos(sp.cos(1.41588210657922*s*sp.sqrt(s + 0.604307210566622))) + 0.858727559696012*sp.tanh(sp.cos(5.00420342832107*s)) + 0.858727559696012*sp.tanh(sp.cos(s**(5/4))) + 0.858727559696012*sp.tanh(sp.cos(sp.sqrt(s)*sp.sin(s + 0.676067862627105))) + 0.858727559696012*sp.tanh(sp.cos(s*(1.00012798041202*s + 0.0366189934736865))) - 0.338962175708043*sp.acos(sp.sin(0.765267107370348*s)) + 2.46978271550185*sp.acos(sp.sin(0.517512499805315*s + 0.583248754437246)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.822982157197199))) + 1.49049429686738*sp.asin(sp.cos(0.25*s)) + 1.49049429686738*sp.asin(sp.cos(0.26580222883408*s)) + 1.49049429686738*sp.asin(sp.cos(0.594932778023209*s)) + 0.858727559696012*sp.asin(sp.cos(0.983157481032705*sp.sqrt(s) + 0.983157481032705*s)) + sp.asin((1/((1/2)*sp.exp(3.14831501888572*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-3.14831501888572*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) - 2.10194914923187 if fitPlotFunc else lambda s: -0.055192322797903*s*np.sin(0.262783179800533*s) - 1.47367036896874*s*np.sin(s + 0.481547008279204)*(1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))) - 0.355081236245643*s*np.tanh(np.sin(1.08967676893512*np.sqrt(s))) + 8.20785835154937*(3.40324094855718 - 8.1723006650769e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + 6.59020168992283*(2*s - 0.250338047986874)*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0402588826737863) + (-0.705063707702998*np.cos(s) - 0.383295880776239)*np.sin(s*(0.87271603678427 - 0.888385561585661*s)) + 0.858727559696012*np.sin(np.sqrt(s))*np.cos(2*s) - 5.50083496936074*np.sin(0.367879441171442*s) + 1.49049429686738*np.sin(0.713731637960093*s) + 1.49049429686738*np.sin(0.650863238034514*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.858727559696012*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.858727559696012*np.sin(1.01990937053213*s*np.sin(0.999855529823022*s)) + 0.858727559696012*np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + 2.46978271550185*np.sin(0.451582705289455*s - 0.362934014061473) - 0.858727559696012*np.sin(0.631449858567625*s + 0.355414129305571) - 0.858727559696012*np.sin(np.sin(1.01401579797849*np.sqrt(s) + 1.01401579797849*s)) - 8.20785835154937*np.cos(0.184501965675006*s) + 1.49049429686738*np.cos(0.859238155913655*s) + 0.858727559696012*np.cos(1.52297301362374*s**2) + 0.858727559696012*np.cos(s*(1.59692136842694 - s)) + 0.858727559696012*np.cos(s*(2*s + 0.258012275465596)) + 0.858727559696012*np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.49049429686738*np.cos(0.956994426515978*s + 0.709118088008111) - np.cos(np.cos(1.41588210657922*s*np.sqrt(s + 0.604307210566622))) + 0.858727559696012*np.tanh(np.cos(5.00420342832107*s)) + 0.858727559696012*np.tanh(np.cos(s**(5/4))) + 0.858727559696012*np.tanh(np.cos(np.sqrt(s)*np.sin(s + 0.676067862627105))) + 0.858727559696012*np.tanh(np.cos(s*(1.00012798041202*s + 0.0366189934736865))) - 0.338962175708043*np.acos(np.sin(0.765267107370348*s)) + 2.46978271550185*np.acos(np.sin(0.517512499805315*s + 0.583248754437246)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.822982157197199))) + 1.49049429686738*np.asin(np.cos(0.25*s)) + 1.49049429686738*np.asin(np.cos(0.26580222883408*s)) + 1.49049429686738*np.asin(np.cos(0.594932778023209*s)) + 0.858727559696012*np.asin(np.cos(0.983157481032705*np.sqrt(s) + 0.983157481032705*s)) + np.asin((1/((1/2)*np.exp(3.14831501888572*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-3.14831501888572*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) - 2.10194914923187

        plot_func_eqn = r"$z(s) = - 0.06\cdot s\cdot \sin{\left(0.26\cdot s \right)} - 1.47\cdot s\cdot \sin{\left(s + 0.48 \right)}\cdot \operatorname{sech}{\left(3.57\cdot s - 425 \right)} - 0.36\cdot s\cdot \tanh{\left(\sin{\left(1.09\cdot \sqrt{s} \right)} \right)} + 6.59\cdot \left(2\cdot s - 0.25\right)\cdot \left(\sqrt{\operatorname{sech}{\left(s \right)}} - 0.04\right) + \left(- 0.71\cdot \cos{\left(s \right)} - 0.38\right)\cdot \sin{\left(s\cdot \left(0.87 - 0.89\cdot s\right) \right)} + 0.86\cdot \sin{\left(\sqrt{s} \right)}\cdot \cos{\left(2\cdot s \right)} - 5.5\cdot \sin{\left(0.37\cdot s \right)} + 1.49\cdot \sin{\left(0.71\cdot s \right)} + 1.49\cdot \sin{\left(0.65\cdot \sqrt{s}\cdot \sin{\left(\sqrt{s} \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \left(\operatorname{acos}{\left(\sin{\left(s \right)} \right)} - 0.27\right) \right)} + 0.86\cdot \sin{\left(1.02\cdot s\cdot \sin{\left(1.0\cdot s \right)} \right)} + 0.86\cdot \sin{\left(s\cdot \cos{\left(\operatorname{sech}{\left(0.01\cdot s \right)} \right)} \right)} + 27.914\cdot \sin{\left(0.14\cdot s + 0.14\cdot \sin{\left(\sqrt{s} \right)} \right)} + 2.47\cdot \sin{\left(0.45\cdot s - 0.36 \right)} - 0.86\cdot \sin{\left(0.63\cdot s + 0.36 \right)} - 0.86\cdot \sin{\left(\sin{\left(1.01\cdot \sqrt{s} + 1.01\cdot s \right)} \right)} - 8.21\cdot \cos{\left(0.18\cdot s \right)} + 1.49\cdot \cos{\left(0.86\cdot s \right)} + 0.86\cdot \cos{\left(1.52\cdot s^{2} \right)} + 0.86\cdot \cos{\left(s\cdot \left(1.6 - s\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(2\cdot s + 0.26\right) \right)} + 0.86\cdot \cos{\left(s\cdot \left(\operatorname{asin}{\left(\cos{\left(s \right)} \right)} + 2\right) \right)} + 1.49\cdot \cos{\left(0.96\cdot s + 0.71 \right)} - \cos{\left(\cos{\left(1.42\cdot s\cdot \sqrt{s + 0.6} \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(5.0\cdot s \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s^{\frac{5}{4}} \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(\sqrt{s}\cdot \sin{\left(s + 0.68 \right)} \right)} \right)} + 0.86\cdot \tanh{\left(\cos{\left(s\cdot \left(1.0\cdot s + 0.04\right) \right)} \right)} - 0.34\cdot \operatorname{acos}{\left(\sin{\left(0.77\cdot s \right)} \right)} + 2.47\cdot \operatorname{acos}{\left(\sin{\left(0.52\cdot s + 0.58 \right)} \right)} + \operatorname{asin}{\left(0.04\cdot \sqrt{s}\cdot \operatorname{asin}{\left(\cos{\left(0.41\cdot s - 0.41\cdot \cos{\left(s \right)} + 0.82 \right)} \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.25\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.27\cdot s \right)} \right)} + 1.49\cdot \operatorname{asin}{\left(\cos{\left(0.59\cdot s \right)} \right)} + 0.86\cdot \operatorname{asin}{\left(\cos{\left(0.98\cdot \sqrt{s} + 0.98\cdot s \right)} \right)} + \operatorname{asin}{\left(\operatorname{sech}{\left(6.3\cdot \sin{\left(s \right)} \right)} \right)} - 2.1$".replace("x_{0}","s")
#        plot_func = None
#        plot_func_eqn = None
