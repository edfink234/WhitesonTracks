...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset_only:
        ...
        eps = .02
        w = 0.28
        plot_func =        -sp.sqrt(s) + 2*s**2*(-2*s - 0.169374642587706)*(-sp.acos(s) - 0.319478041289035) - s*(2.47062552368742*s - sp.sin(30.4050477500066*s) - 1.4209203669243)*sp.cos(128.229040348727*s + 14.8127547645076*sp.tanh(s) + 0.643635974894591)*sp.tanh(s - 0.42789822420058)*sp.acos(s) + s*(-0.328482871897932*sp.sqrt(sp.acos(s)) + sp.sqrt(sp.acos(sp.sin(s + 0.689431513685724))) - 0.328482871897932*sp.asin(sp.cos(s + sp.asin(s) + 1))) + (0.979236006268781 - s**2)*(s + 1.39793562331722)*(sp.tanh(sp.acos(s)) + 0.0470999457933233)*(-s + sp.acos(s) + 0.083289273989246)*(s**3 + s - 0.0347732499555539)*sp.cos(49.6016134939281*sp.acos(s)) + (s + 0.122718872470888)*(s + (sp.sech((sp.sech(sp.cos(129.010537305414*s - 44.3458325815834*sp.sin(s)))))))*sp.acos(s) - 2*(sp.acos(sp.asin((sp.sech(sp.asin(sp.cos(sp.cos(s) - sp.acos(s))))))) + 0.228488998754687)*sp.acos(s)**2 + 2.06677823528523*(sp.sqrt(1 - sp.sin(5.46069308055838*s)**2) + (0.166067809690497*s + 0.718389599823267)*(17.6020476627984*sp.sin(5.38484588599688*s) - 5.62824046654484*sp.sin(9.81799848956101*s) - 13.7859951054949*sp.sin(13.4000533974842*s) + sp.cos(33*s)) - 0.144366090217575*sp.sin(26.7019167669519*sp.acos(s)) - 0.313139568275323*sp.cos(92.475900215986*sp.cos(s)))*sp.cos(0.503013391618199*sp.cos(3.13656065983025*s)) - 2.06677823528523*sp.sqrt(sp.sin(s)) + sp.acos(sp.sqrt(s)) - 1.9227509041142*sp.asin(sp.acos(sp.sin(sp.acos(s) + 0.88061075992745)))**(1/8) - 2.06677823528523*sp.asin((sp.sech(sp.sin(sp.cos(14.7416061068815*s))))) - 0.00420196788541908 if fitPlotFunc else lambda s: -np.sqrt(s) + 2*s**2*(-2*s - 0.169374642587706)*(-np.acos(s) - 0.319478041289035) - s*(2.47062552368742*s - np.sin(30.4050477500066*s) - 1.4209203669243)*np.cos(128.229040348727*s + 14.8127547645076*np.tanh(s) + 0.643635974894591)*np.tanh(s - 0.42789822420058)*np.acos(s) + s*(-0.328482871897932*np.sqrt(np.acos(s)) + np.sqrt(np.acos(np.sin(s + 0.689431513685724))) - 0.328482871897932*np.asin(np.cos(s + np.asin(s) + 1))) + (0.979236006268781 - s**2)*(s + 1.39793562331722)*(np.tanh(np.acos(s)) + 0.0470999457933233)*(-s + np.acos(s) + 0.083289273989246)*(s**3 + s - 0.0347732499555539)*np.cos(49.6016134939281*np.acos(s)) + (s + 0.122718872470888)*(s + (np.sech((np.sech(np.cos(129.010537305414*s - 44.3458325815834*np.sin(s)))))))*np.acos(s) - 2*(np.acos(np.asin((np.sech(np.asin(np.cos(np.cos(s) - np.acos(s))))))) + 0.228488998754687)*np.acos(s)**2 + 2.06677823528523*(np.sqrt(1 - np.sin(5.46069308055838*s)**2) + (0.166067809690497*s + 0.718389599823267)*(17.6020476627984*np.sin(5.38484588599688*s) - 5.62824046654484*np.sin(9.81799848956101*s) - 13.7859951054949*np.sin(13.4000533974842*s) + np.cos(33*s)) - 0.144366090217575*np.sin(26.7019167669519*np.acos(s)) - 0.313139568275323*np.cos(92.475900215986*np.cos(s)))*np.cos(0.503013391618199*np.cos(3.13656065983025*s)) - 2.06677823528523*np.sqrt(np.sin(s)) + np.acos(np.sqrt(s)) - 1.9227509041142*np.asin(np.acos(np.sin(np.acos(s) + 0.88061075992745)))**(1/8) - 2.06677823528523*np.asin((np.sech(np.sin(np.cos(14.7416061068815*s))))) - 0.00420196788541908
