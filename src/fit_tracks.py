...
#    print(SIG_X_LIST[0], SIG_Y_LIST[0], SIG_Z_LIST[0]); exit()
    ...
    if create_dataset:
        ...
        eps = .02
        w = 0.28
        plot_func =    13.1196760715614*s*(sp.sqrt((1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s)))) - 0.0405919570569808) - 0.0533758800149565*s*sp.sin(0.262783179800533*s) - 1.37732236257448*s*sp.sin(s + 0.486522433734834)*(1/((1/2)*sp.exp(425 - 3.57142857142857*s) + (1/2)*sp.exp(3.57142857142857*s - 425))) - 0.00587025943236308*s*sp.sin(0.429203673205103*s**2 - 0.987105331750556) - 0.355149008740764*s*sp.tanh(sp.sin(1.08978594419407*sp.sqrt(s))) + 8.1123423333124*(3.42909060581338 - 8.1723006650769e-7*s**3)*sp.sin(0.135994202248106*s + 0.135994202248106*sp.sin(sp.sqrt(s))) + (0.000968365327271516*s + (-0.430495473734879*sp.sin(s)*sp.cos(sp.sqrt(s)) - 0.430495473734879*sp.cos(s) - 0.0353722570223971)*sp.sin(s))*sp.cos(0.856996688691341*s - 0.352668311874884) - 0.53974758194437*(s - 3.80658978935181)*(-s*sp.cos(s) - sp.sin(s) - 0.887275272435725)*(1/((1/2)*sp.exp(0.371435670950793*s) + (1/2)*sp.exp(-0.371435670950793*s))) + (0.801715025584661*sp.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.268116749808624)*sp.cos(s) - (0.705547784046277*sp.cos(s) + 0.385422706546299)*sp.sin(s*(0.873915548987299 - 0.888385561585661*s)) + ((1/((1/2)*sp.exp((1/2)*1j*(sp.exp(1j*(-s - 0.0172135008132539)*(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) - sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))/(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) + sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))) - sp.exp(-1j*(-s - 0.0172135008132539)*(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) - sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))/(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) + sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))))) + (1/2)*sp.exp(-1/2*1j*(sp.exp(1j*(-s - 0.0172135008132539)*(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) - sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))/(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) + sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))) - sp.exp(-1j*(-s - 0.0172135008132539)*(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) - sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))/(sp.exp((sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))) + sp.exp(-(sp.exp(s) - sp.exp(-s))/(sp.exp(s) + sp.exp(-s))))))))) - (1/((1/2)*sp.exp(sp.asin((1/2)*sp.exp(1j*(-0.907041119573385*s - 0.481736622767551)) + (1/2)*sp.exp(1j*(0.907041119573385*s + 0.481736622767551)))) + (1/2)*sp.exp(-sp.asin((1/2)*sp.exp(1j*(-0.907041119573385*s - 0.481736622767551)) + (1/2)*sp.exp(1j*(0.907041119573385*s + 0.481736622767551)))))))*(-2.36143851066738*sp.sin(s) + 2.36143851066738*sp.tanh(s) - 0.774202835932862) + 0.862136521960749*sp.sin(sp.sqrt(s))*sp.cos(2*s) - 5.58470698197144*sp.sin(0.367879441171442*s) + 1.48985910948332*sp.sin(0.713731637960093*s) + 1.48985910948332*sp.sin(0.637439071877847*sp.sqrt(s)*sp.sin(sp.sqrt(s))) + 0.862136521960749*sp.sin(s*(sp.acos(sp.sin(s)) - 0.27450007703406)) + 0.862136521960749*sp.sin(1.01953589794796*s*sp.sin(0.999857337167407*s)) + 0.862136521960749*sp.sin(s*sp.cos((1/((1/2)*sp.exp(0.0136985281801015*s) + (1/2)*sp.exp(-0.0136985281801015*s))))) + 2.43567776775479*sp.sin(0.451582705289455*s - 0.353905866914217) - 0.862136521960749*sp.sin(0.631449858567625*s + 0.424754322747821) + sp.sin(sp.cos(s)) - 8.1123423333124*sp.cos(0.184501965675006*s) + 1.48985910948332*sp.cos(0.859238155913655*s) - sp.cos(s)*sp.asin((1/((1/2)*sp.exp(-1/2*sp.exp(-1/2*sp.exp(1.97493799097939*1j*s) + (1/2)*sp.exp(-1.97493799097939*1j*s)) - 1/2*sp.exp((1/2)*sp.exp(1.97493799097939*1j*s) - 1/2*sp.exp(-1.97493799097939*1j*s))) + (1/2)*sp.exp((1/2)*sp.exp(-1/2*sp.exp(1.97493799097939*1j*s) + (1/2)*sp.exp(-1.97493799097939*1j*s)) + (1/2)*sp.exp((1/2)*sp.exp(1.97493799097939*1j*s) - 1/2*sp.exp(-1.97493799097939*1j*s)))))) + 0.208675762948436*sp.cos(1.44312628154549*s) + 0.862136521960749*sp.cos(1.52297301362374*s**2) + 0.862136521960749*sp.cos(sp.sqrt(s)*sp.sin(s + 0.712625432152873)) + 0.862136521960749*sp.cos(s*(1.59791550260512 - s)) + 0.862136521960749*sp.cos(s*(2*s + 0.258012275465596)) - 0.289891431868783*sp.cos(s*(1.00733568746387*sp.sin(s) + 1.91878516265159)) + 0.862136521960749*sp.cos(s*(sp.asin(sp.cos(s)) + 2)) + 1.48985910948332*sp.cos(0.956994426515978*s + 0.691872655771829) + 0.413071399991811*sp.cos(1.10583897256825*s*(-(1/((1/2)*sp.exp(s) + (1/2)*sp.exp(-s))) - sp.sqrt((1/((1/2)*sp.exp((1/2)*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-1/2*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) + 0.705026843555238) - 0.0704369770820429) + sp.cos(sp.sin(1.41588210657922*s*sp.sqrt(s + 0.604307210566622))) - 0.862136521960749*sp.tanh(sp.sin(1.01529160718941*sp.sqrt(s) + 1.01529160718941*s)) + 0.862136521960749*sp.tanh(sp.cos(5.00420342832107*s)) + 0.862136521960749*sp.tanh(sp.cos(s**(5/4))) + 0.454048579762134*sp.tanh(sp.cos(s*(s + 0.26580222883408))) + 0.862136521960749*sp.tanh(sp.cos(s*(1.00013814966728*s + 0.0366189934736865))) - 0.482673089754243*sp.acos(sp.sin(0.765267107370348*s)) + 2.43567776775479*sp.acos(sp.sin(0.517512499805315*s + 0.52597924249054)) + sp.asin(0.0366189934736865*sp.sqrt(s)*sp.asin(sp.cos(0.411491078598599*s - 0.411491078598599*sp.cos(s) + 0.844209693212733))) + 1.48985910948332*sp.asin(sp.cos(0.25*s)) + 1.48985910948332*sp.asin(sp.cos(0.26580222883408*s)) + 1.48985910948332*sp.asin(sp.cos(0.594932778023209*s)) + 0.862136521960749*sp.asin(sp.cos(0.983047194673816*sp.sqrt(s) + 0.983047194673816*s)) + sp.asin((1/((1/2)*sp.exp(2.63618723881571*1j*(sp.exp(1j*s) - sp.exp(-1j*s))) + (1/2)*sp.exp(-2.63618723881571*1j*(sp.exp(1j*s) - sp.exp(-1j*s)))))) - 3.25445510347487 if fitPlotFunc else lambda s: 13.1196760715614*s*(np.sqrt((1/((1/2)*np.exp(s) + (1/2)*np.exp(-s)))) - 0.0405919570569808) - 0.0533758800149565*s*np.sin(0.262783179800533*s) - 1.37732236257448*s*np.sin(s + 0.486522433734834)*(1/((1/2)*np.exp(425 - 3.57142857142857*s) + (1/2)*np.exp(3.57142857142857*s - 425))) - 0.00587025943236308*s*np.sin(0.429203673205103*s**2 - 0.987105331750556) - 0.355149008740764*s*np.tanh(np.sin(1.08978594419407*np.sqrt(s))) + 8.1123423333124*(3.42909060581338 - 8.1723006650769e-7*s**3)*np.sin(0.135994202248106*s + 0.135994202248106*np.sin(np.sqrt(s))) + (0.000968365327271516*s + (-0.430495473734879*np.sin(s)*np.cos(np.sqrt(s)) - 0.430495473734879*np.cos(s) - 0.0353722570223971)*np.sin(s))*np.cos(0.856996688691341*s - 0.352668311874884) - 0.53974758194437*(s - 3.80658978935181)*(-s*np.cos(s) - np.sin(s) - 0.887275272435725)*(1/((1/2)*np.exp(0.371435670950793*s) + (1/2)*np.exp(-0.371435670950793*s))) + (0.801715025584661*np.sin((2.5889642945934 - s)*(-s - 0.62334383896769)) + 0.268116749808624)*np.cos(s) - (0.705547784046277*np.cos(s) + 0.385422706546299)*np.sin(s*(0.873915548987299 - 0.888385561585661*s)) + ((1/((1/2)*np.exp((1/2)*1j*(np.exp(1j*(-s - 0.0172135008132539)*(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) - np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))/(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) + np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))) - np.exp(-1j*(-s - 0.0172135008132539)*(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) - np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))/(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) + np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))))) + (1/2)*np.exp(-1/2*1j*(np.exp(1j*(-s - 0.0172135008132539)*(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) - np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))/(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) + np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))) - np.exp(-1j*(-s - 0.0172135008132539)*(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) - np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))/(np.exp((np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))) + np.exp(-(np.exp(s) - np.exp(-s))/(np.exp(s) + np.exp(-s))))))))) - (1/((1/2)*np.exp(np.asin((1/2)*np.exp(1j*(-0.907041119573385*s - 0.481736622767551)) + (1/2)*np.exp(1j*(0.907041119573385*s + 0.481736622767551)))) + (1/2)*np.exp(-np.asin((1/2)*np.exp(1j*(-0.907041119573385*s - 0.481736622767551)) + (1/2)*np.exp(1j*(0.907041119573385*s + 0.481736622767551)))))))*(-2.36143851066738*np.sin(s) + 2.36143851066738*np.tanh(s) - 0.774202835932862) + 0.862136521960749*np.sin(np.sqrt(s))*np.cos(2*s) - 5.58470698197144*np.sin(0.367879441171442*s) + 1.48985910948332*np.sin(0.713731637960093*s) + 1.48985910948332*np.sin(0.637439071877847*np.sqrt(s)*np.sin(np.sqrt(s))) + 0.862136521960749*np.sin(s*(np.acos(np.sin(s)) - 0.27450007703406)) + 0.862136521960749*np.sin(1.01953589794796*s*np.sin(0.999857337167407*s)) + 0.862136521960749*np.sin(s*np.cos((1/((1/2)*np.exp(0.0136985281801015*s) + (1/2)*np.exp(-0.0136985281801015*s))))) + 2.43567776775479*np.sin(0.451582705289455*s - 0.353905866914217) - 0.862136521960749*np.sin(0.631449858567625*s + 0.424754322747821) + np.sin(np.cos(s)) - 8.1123423333124*np.cos(0.184501965675006*s) + 1.48985910948332*np.cos(0.859238155913655*s) - np.cos(s)*np.asin((1/((1/2)*np.exp(-1/2*np.exp(-1/2*np.exp(1.97493799097939*1j*s) + (1/2)*np.exp(-1.97493799097939*1j*s)) - 1/2*np.exp((1/2)*np.exp(1.97493799097939*1j*s) - 1/2*np.exp(-1.97493799097939*1j*s))) + (1/2)*np.exp((1/2)*np.exp(-1/2*np.exp(1.97493799097939*1j*s) + (1/2)*np.exp(-1.97493799097939*1j*s)) + (1/2)*np.exp((1/2)*np.exp(1.97493799097939*1j*s) - 1/2*np.exp(-1.97493799097939*1j*s)))))) + 0.208675762948436*np.cos(1.44312628154549*s) + 0.862136521960749*np.cos(1.52297301362374*s**2) + 0.862136521960749*np.cos(np.sqrt(s)*np.sin(s + 0.712625432152873)) + 0.862136521960749*np.cos(s*(1.59791550260512 - s)) + 0.862136521960749*np.cos(s*(2*s + 0.258012275465596)) - 0.289891431868783*np.cos(s*(1.00733568746387*np.sin(s) + 1.91878516265159)) + 0.862136521960749*np.cos(s*(np.asin(np.cos(s)) + 2)) + 1.48985910948332*np.cos(0.956994426515978*s + 0.691872655771829) + 0.413071399991811*np.cos(1.10583897256825*s*(-(1/((1/2)*np.exp(s) + (1/2)*np.exp(-s))) - np.sqrt((1/((1/2)*np.exp((1/2)*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-1/2*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) + 0.705026843555238) - 0.0704369770820429) + np.cos(np.sin(1.41588210657922*s*np.sqrt(s + 0.604307210566622))) - 0.862136521960749*np.tanh(np.sin(1.01529160718941*np.sqrt(s) + 1.01529160718941*s)) + 0.862136521960749*np.tanh(np.cos(5.00420342832107*s)) + 0.862136521960749*np.tanh(np.cos(s**(5/4))) + 0.454048579762134*np.tanh(np.cos(s*(s + 0.26580222883408))) + 0.862136521960749*np.tanh(np.cos(s*(1.00013814966728*s + 0.0366189934736865))) - 0.482673089754243*np.acos(np.sin(0.765267107370348*s)) + 2.43567776775479*np.acos(np.sin(0.517512499805315*s + 0.52597924249054)) + np.asin(0.0366189934736865*np.sqrt(s)*np.asin(np.cos(0.411491078598599*s - 0.411491078598599*np.cos(s) + 0.844209693212733))) + 1.48985910948332*np.asin(np.cos(0.25*s)) + 1.48985910948332*np.asin(np.cos(0.26580222883408*s)) + 1.48985910948332*np.asin(np.cos(0.594932778023209*s)) + 0.862136521960749*np.asin(np.cos(0.983047194673816*np.sqrt(s) + 0.983047194673816*s)) + np.asin((1/((1/2)*np.exp(2.63618723881571*1j*(np.exp(1j*s) - np.exp(-1j*s))) + (1/2)*np.exp(-2.63618723881571*1j*(np.exp(1j*s) - np.exp(-1j*s)))))) - 3.25445510347487
